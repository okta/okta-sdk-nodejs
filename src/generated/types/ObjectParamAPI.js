...
exports.ObjectGroupOwnerApi = ObjectGroupOwnerApi;
...
class ObjectGroupPushMappingApi {
    ...
    listGroupPushMappings(param, options) {
        return this.api.listGroupPushMappings(param.appId, param.after, param.limit, param.search, param.sortBy, param.sortOrder, options).toPromise();
    }
    /**
