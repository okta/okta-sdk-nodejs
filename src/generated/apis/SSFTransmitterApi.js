...
exports.SSFTransmitterApiResponseProcessor = exports.SSFTransmitterApiRequestFactory = void 0;
 ...
 * no description
 */
class SSFTransmitterApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param instance
     */
  async createSsfStream(instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'instance' is not null or undefined
    if (instance === null || instance === undefined) {
      throw new baseapi_1.RequiredError('SSFTransmitterApi', 'createSsfStream', 'instance');
    }
    // Path Params
    const path = '/api/v1/ssf/stream';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(instance, 'StreamConfigurationCreateRequest', ''), contentType);
  ...
  /**
     ...
     */
  async deleteSsfStream(streamId, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/ssf/stream';
    // Make Request Context
    ...
    if (streamId !== undefined) {
      requestContext.setQueryParam('stream_id', ObjectSerializer_1.ObjectSerializer.serialize(streamId, 'string', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['oauth2'];
  ...
  /**
     ...
     * @param streamId The ID of the specified SSF Stream configuration
     */
  async getSsfStreamStatus(streamId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'streamId' is not null or undefined
    if (streamId === null || streamId === undefined) {
      throw new baseapi_1.RequiredError('SSFTransmitterApi', 'getSsfStreamStatus', 'streamId');
    }
    // Path Params
    const path = '/api/v1/ssf/stream/status';
    // Make Request Context
  ...
  /**
     ...
     * @param streamId The ID of the specified SSF Stream configuration
     */
  async getSsfStreams(streamId, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/ssf/stream';
    // Make Request Context
  ...
  /**
     ...
     */
  async getWellknownSsfMetadata(_options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/.well-known/ssf-configuration';
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(path, http_1.HttpMethodEnum.GET);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
    const defaultAuth = _options?.authMethods?.default || this.configuration?.authMethods?.default;
  ...
  /**
     ...
     * @param instance
     */
  async replaceSsfStream(instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'instance' is not null or undefined
    if (instance === null || instance === undefined) {
      throw new baseapi_1.RequiredError('SSFTransmitterApi', 'replaceSsfStream', 'instance');
    }
    // Path Params
    const path = '/api/v1/ssf/stream';
    // Make Request Context
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(instance, 'StreamConfiguration', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['oauth2'];
  ...
  /**
     ...
     * @param instance
     */
  async updateSsfStream(instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'instance' is not null or undefined
    if (instance === null || instance === undefined) {
      throw new baseapi_1.RequiredError('SSFTransmitterApi', 'updateSsfStream', 'instance');
    }
    // Path Params
    const path = '/api/v1/ssf/stream';
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(path, http_1.HttpMethodEnum.PATCH);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
    // Body Params
    const [contentType, contentEncoding] = ObjectSerializer_1.ObjectSerializer.getPreferredMediaTypeAndEncoding([
      'application/json'
  ...
  /**
     ...
     * @param instance
     */
  async verifySsfStream(instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'instance' is not null or undefined
    if (instance === null || instance === undefined) {
      throw new baseapi_1.RequiredError('SSFTransmitterApi', 'verifySsfStream', 'instance');
    }
    // Path Params
    const path = '/api/v1/ssf/stream/verification';
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(path, http_1.HttpMethodEnum.POST);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
    // Body Params
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(instance, 'StreamVerificationRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['oauth2'];
...
exports.SSFTransmitterApiRequestFactory = SSFTransmitterApiRequestFactory;
class SSFTransmitterApiResponseProcessor {
  /**
     ...
     */
  async createSsfStream(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('201', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'StreamConfiguration', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'StreamConfiguration'), 'StreamConfiguration', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteSsfStream(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getSsfStreamStatus(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'StreamStatus', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('400', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'StreamStatus'), 'StreamStatus', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getSsfStreams(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'GetSsfStreams200Response', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('401', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'GetSsfStreams200Response'), 'GetSsfStreams200Response', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getWellknownSsfMetadata(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'WellKnownSSFMetadata', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('401', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'WellKnownSSFMetadata'), 'WellKnownSSFMetadata', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceSsfStream(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'StreamConfiguration', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateSsfStream(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'StreamConfiguration', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async verifySsfStream(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
...
exports.SSFTransmitterApiResponseProcessor = SSFTransmitterApiResponseProcessor;
