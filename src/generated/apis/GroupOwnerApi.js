...
exports.GroupOwnerApiResponseProcessor = exports.GroupOwnerApiRequestFactory = void 0;
 ...
 * no description
 */
class GroupOwnerApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
  ...
  async assignGroupOwner(groupId, groupOwner, _options) {
    ...
    if (groupId === null || groupId === undefined) {
      throw new baseapi_1.RequiredError('GroupOwnerApi', 'assignGroupOwner', 'groupId');
    }
    // verify required parameter 'groupOwner' is not null or undefined
    if (groupOwner === null || groupOwner === undefined) {
      throw new baseapi_1.RequiredError('GroupOwnerApi', 'assignGroupOwner', 'groupOwner');
    }
    // Path Params
  ...
  async deleteGroupOwner(groupId, ownerId, _options) {
    ...
    // verify required parameter 'groupId' is not null or undefined
    if (groupId === null || groupId === undefined) {
      throw new baseapi_1.RequiredError('GroupOwnerApi', 'deleteGroupOwner', 'groupId');
    }
    // verify required parameter 'ownerId' is not null or undefined
    if (ownerId === null || ownerId === undefined) {
      throw new baseapi_1.RequiredError('GroupOwnerApi', 'deleteGroupOwner', 'ownerId');
    }
    // Path Params
  ...
  async listGroupOwners(groupId, search, after, limit, _options) {
    ...
    // verify required parameter 'groupId' is not null or undefined
    if (groupId === null || groupId === undefined) {
      throw new baseapi_1.RequiredError('GroupOwnerApi', 'listGroupOwners', 'groupId');
    }
    // Path Params
    const path = '/api/v1/groups/{groupId}/owners';
    const vars = {
...
exports.GroupOwnerApiRequestFactory = GroupOwnerApiRequestFactory;
class GroupOwnerApiResponseProcessor {
  /**
...
exports.GroupOwnerApiResponseProcessor = GroupOwnerApiResponseProcessor;
