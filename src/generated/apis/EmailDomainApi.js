...
exports.EmailDomainApiResponseProcessor = exports.EmailDomainApiRequestFactory = void 0;
...
class EmailDomainApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async createEmailDomain(emailDomain, _options) {
    ...
    if (emailDomain === null || emailDomain === undefined) {
      throw new baseapi_1.RequiredError('EmailDomainApi', 'createEmailDomain', 'emailDomain');
    }
    // Path Params
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(emailDomain, 'EmailDomain', ''), contentType);
  ...
  async deleteEmailDomain(emailDomainId, _options) {
    ...
    if (emailDomainId === null || emailDomainId === undefined) {
      throw new baseapi_1.RequiredError('EmailDomainApi', 'deleteEmailDomain', 'emailDomainId');
    }
    // Path Params
  ...
  async getEmailDomain(emailDomainId, _options) {
    ...
    // verify required parameter 'emailDomainId' is not null or undefined
    if (emailDomainId === null || emailDomainId === undefined) {
      throw new baseapi_1.RequiredError('EmailDomainApi', 'getEmailDomain', 'emailDomainId');
    }
    // Path Params
    const path = '/api/v1/email-domains/{emailDomainId}';
    const vars = {
  ...
  async updateEmailDomain(emailDomainId, updateEmailDomain, _options) {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateEmailDomain, 'UpdateEmailDomain', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['API_Token'];
  ...
  async verifyEmailDomain(emailDomainId, _options) {
    ...
    // verify required parameter 'emailDomainId' is not null or undefined
    if (emailDomainId === null || emailDomainId === undefined) {
      throw new baseapi_1.RequiredError('EmailDomainApi', 'verifyEmailDomain', 'emailDomainId');
    }
    // Path Params
    const path = '/api/v1/email-domains/{emailDomainId}/verify';
    const vars = {
      ['emailDomainId']: String(emailDomainId),
    };
    // Make Request Context
...
exports.EmailDomainApiRequestFactory = EmailDomainApiRequestFactory;
class EmailDomainApiResponseProcessor {
  /**
     ...
     */
  async createEmailDomain(response) {
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteEmailDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async verifyEmailDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'EmailDomainResponse', '');
      return body;
...
exports.EmailDomainApiResponseProcessor = EmailDomainApiResponseProcessor;
