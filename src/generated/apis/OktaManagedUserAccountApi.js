...
exports.OktaManagedUserAccountApiResponseProcessor = exports.OktaManagedUserAccountApiRequestFactory = void 0;
 ...
 * no description
 */
class OktaManagedUserAccountApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param body
     */
  async createOktaManagedUserAccount(body, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new baseapi_1.RequiredError('OktaManagedUserAccountApi', 'createOktaManagedUserAccount', 'body');
    }
    // Path Params
    const path = '/privileged-access/api/v1/okta-service-accounts';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, 'OktaManagedUserAccountRequest', ''), contentType);
  ...
  /**
     ...
     */
  async deleteOktaManagedUserAccount(id, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new baseapi_1.RequiredError('OktaManagedUserAccountApi', 'deleteOktaManagedUserAccount', 'id');
    }
    // Path Params
    const path = '/privileged-access/api/v1/okta-service-accounts/{id}';
    const vars = {
      ['id']: String(id),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param id ID of an existing Okta managed user account
     */
  async getOktaManagedUserAccount(id, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new baseapi_1.RequiredError('OktaManagedUserAccountApi', 'getOktaManagedUserAccount', 'id');
    }
    // Path Params
    const path = '/privileged-access/api/v1/okta-service-accounts/{id}';
    const vars = {
  ...
  /**
     ...
     */
  async listOktaManagedUserAccounts(limit, after, match, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/privileged-access/api/v1/okta-service-accounts';
    // Make Request Context
  ...
  /**
     ...
     * @param body
     */
  async updateOktaManagedUserAccount(id, body, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'id' is not null or undefined
    if (id === null || id === undefined) {
      throw new baseapi_1.RequiredError('OktaManagedUserAccountApi', 'updateOktaManagedUserAccount', 'id');
    }
    // Path Params
    const path = '/privileged-access/api/v1/okta-service-accounts/{id}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, 'OktaManagedUserAccountForUpdate', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
...
exports.OktaManagedUserAccountApiRequestFactory = OktaManagedUserAccountApiRequestFactory;
class OktaManagedUserAccountApiResponseProcessor {
  /**
     ...
     */
  async createOktaManagedUserAccount(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('201', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'OktaManagedUserAccount', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'OktaManagedUserAccount'), 'OktaManagedUserAccount', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteOktaManagedUserAccount(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getOktaManagedUserAccount(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listOktaManagedUserAccounts(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<OktaManagedUserAccount>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('400', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<OktaManagedUserAccount>'), 'Array<OktaManagedUserAccount>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateOktaManagedUserAccount(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'OktaManagedUserAccount', '');
      return body;
...
exports.OktaManagedUserAccountApiResponseProcessor = OktaManagedUserAccountApiResponseProcessor;
