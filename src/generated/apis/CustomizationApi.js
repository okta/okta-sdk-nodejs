...
class CustomizationApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  /**
     ...
     */
  async createBrand(createBrandRequest, _options) {
    let _config = _options || this.configuration;
    // Path Params
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(createBrandRequest, 'CreateBrandRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async deleteBrand(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'deleteBrand', 'brandId');
    }
    // Path Params
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async deleteCustomizedErrorPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'deleteCustomizedErrorPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/customized';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async deleteCustomizedSignInPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'deleteCustomizedSignInPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/customized';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async deletePreviewErrorPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'deletePreviewErrorPage', 'brandId');
    }
    // Path Params
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async deletePreviewSignInPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'deletePreviewSignInPage', 'brandId');
    }
    // Path Params
  ...
  /**
     ...
     */
  async getBrand(brandId, expand, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
    ...
    // Query Params
    if (expand !== undefined) {
      requestContext.setQueryParam('expand', ObjectSerializer_1.ObjectSerializer.serialize(expand, 'Array<\'themes\' | \'domains\' | \'emailDomain\'>', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getCustomizedErrorPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getCustomizedErrorPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/customized';
    const vars = {
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getCustomizedSignInPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getCustomizedSignInPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/customized';
    const vars = {
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getDefaultErrorPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getDefaultErrorPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/default';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getDefaultSignInPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getDefaultSignInPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/default';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param expand Specifies additional metadata to be included in the response
     */
  async getErrorPage(brandId, expand, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getErrorPage', 'brandId');
    }
    // Path Params
    ...
    // Query Params
    if (expand !== undefined) {
      requestContext.setQueryParam('expand', ObjectSerializer_1.ObjectSerializer.serialize(expand, 'Array<\'default\' | \'customized\' | \'customizedUrl\' | \'preview\' | \'previewUrl\'>', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getPreviewErrorPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getPreviewErrorPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/preview';
    const vars = {
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getPreviewSignInPage(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getPreviewSignInPage', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/preview';
    const vars = {
  ...
  /**
     ...
     * @param expand Specifies additional metadata to be included in the response
     */
  async getSignInPage(brandId, expand, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getSignInPage', 'brandId');
    }
    // Path Params
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async getSignOutPageSettings(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'getSignOutPageSettings', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-out/customized';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async listAllSignInWidgetVersions(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'listAllSignInWidgetVersions', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/widget-versions';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param brandId The ID of the brand
     */
  async listBrandDomains(brandId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'listBrandDomains', 'brandId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/domains';
    const vars = {
      ['brandId']: String(brandId),
    };
    // Make Request Context
  ...
  /**
     ...
     */
  async listBrands(expand, after, limit, q, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/brands';
    // Make Request Context
  ...
  /**
     ...
     * @param brand
     */
  async replaceBrand(brandId, brand, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceBrand', 'brandId');
    }
    // verify required parameter 'brand' is not null or undefined
    if (brand === null || brand === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceBrand', 'brand');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(brand, 'BrandRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param theme
     */
  async replaceBrandTheme(brandId, themeId, theme, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceBrandTheme', 'brandId');
    }
    // verify required parameter 'themeId' is not null or undefined
    if (themeId === null || themeId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceBrandTheme', 'themeId');
    }
    // verify required parameter 'theme' is not null or undefined
    if (theme === null || theme === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceBrandTheme', 'theme');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/themes/{themeId}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(theme, 'UpdateThemeRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param errorPage
     */
  async replaceCustomizedErrorPage(brandId, errorPage, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceCustomizedErrorPage', 'brandId');
    }
    // verify required parameter 'errorPage' is not null or undefined
    if (errorPage === null || errorPage === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceCustomizedErrorPage', 'errorPage');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/customized';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(errorPage, 'ErrorPage', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param signInPage
     */
  async replaceCustomizedSignInPage(brandId, signInPage, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceCustomizedSignInPage', 'brandId');
    }
    // verify required parameter 'signInPage' is not null or undefined
    if (signInPage === null || signInPage === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceCustomizedSignInPage', 'signInPage');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/customized';
    const vars = {
  ...
  /**
     ...
     */
  async replaceEmailCustomization(brandId, templateName, customizationId, instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceEmailCustomization', 'brandId');
    }
    // verify required parameter 'templateName' is not null or undefined
    if (templateName === null || templateName === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceEmailCustomization', 'templateName');
    }
    // verify required parameter 'customizationId' is not null or undefined
    if (customizationId === null || customizationId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceEmailCustomization', 'customizationId');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/templates/email/{templateName}/customizations/{customizationId}';
    const vars = {
  ...
  /**
     ...
     * @param emailSettings
     */
  async replaceEmailSettings(brandId, templateName, emailSettings, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceEmailSettings', 'brandId');
    }
    // verify required parameter 'templateName' is not null or undefined
    if (templateName === null || templateName === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replaceEmailSettings', 'templateName');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/templates/email/{templateName}/settings';
    const vars = {
  ...
  /**
     ...
     * @param errorPage
     */
  async replacePreviewErrorPage(brandId, errorPage, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replacePreviewErrorPage', 'brandId');
    }
    // verify required parameter 'errorPage' is not null or undefined
    if (errorPage === null || errorPage === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replacePreviewErrorPage', 'errorPage');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/error/preview';
    const vars = {
  ...
  /**
     ...
     * @param signInPage
     */
  async replacePreviewSignInPage(brandId, signInPage, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'brandId' is not null or undefined
    if (brandId === null || brandId === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replacePreviewSignInPage', 'brandId');
    }
    // verify required parameter 'signInPage' is not null or undefined
    if (signInPage === null || signInPage === undefined) {
      throw new baseapi_1.RequiredError('CustomizationApi', 'replacePreviewSignInPage', 'signInPage');
    }
    // Path Params
    const path = '/api/v1/brands/{brandId}/pages/sign-in/preview';
    const vars = {
...
class CustomizationApiResponseProcessor {
  ...
  async bulkRemoveEmailAddressBounces(response) {
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'BouncesRemoveListResult'), 'BouncesRemoveListResult', '');
      return body;
    }
  ...
  async createBrand(response) {
    ...
    if ((0, util_1.isCodeInRange)('409', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
      throw new exception_1.ApiException(409, 'Could not create the new brand because same name already exist.', body, response.headers);
    }
    if ((0, util_1.isCodeInRange)('429', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
      throw new exception_1.ApiException(429, 'Too Many Requests', body, response.headers);
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Brand'), 'Brand', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async createEmailCustomization(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailCustomization'), 'EmailCustomization', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteCustomizedErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteCustomizedSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deletePreviewErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deletePreviewSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
  ...
  async getBrand(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'BrandWithEmbedded', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'BrandWithEmbedded'), 'BrandWithEmbedded', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async getBrandTheme(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ThemeResponse'), 'ThemeResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async getCustomizationPreview(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailPreview'), 'EmailPreview', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getCustomizedErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ErrorPage', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ErrorPage'), 'ErrorPage', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getCustomizedSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'SignInPage'), 'SignInPage', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getDefaultErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ErrorPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getDefaultSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'SignInPage', '');
      return body;
  ...
  async getEmailDefaultContent(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailDefaultContent'), 'EmailDefaultContent', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async getEmailSettings(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'EmailSettingsResponse', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailSettingsResponse'), 'EmailSettingsResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async getEmailTemplate(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'EmailTemplateResponse', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailTemplateResponse'), 'EmailTemplateResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'PageRoot', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'PageRoot'), 'PageRoot', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getPreviewErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ErrorPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getPreviewSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'SignInPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getSignOutPageSettings(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'HostedPage'), 'HostedPage', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listAllSignInWidgetVersions(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<string>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<string>'), 'Array<string>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listBrandDomains(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'BrandDomains', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'BrandDomains'), 'BrandDomains', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async listBrandThemes(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<ThemeResponse>'), 'Array<ThemeResponse>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async listBrands(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<BrandWithEmbedded>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<BrandWithEmbedded>'), 'Array<BrandWithEmbedded>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async listEmailCustomizations(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<EmailCustomization>'), 'Array<EmailCustomization>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async listEmailTemplates(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<EmailTemplateResponse>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<EmailTemplateResponse>'), 'Array<EmailTemplateResponse>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceBrandTheme(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ThemeResponse', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceCustomizedErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ErrorPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceCustomizedSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'SignInPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceEmailCustomization(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'EmailCustomization', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceEmailSettings(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
    ...
    if ((0, util_1.isCodeInRange)('409', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Error409', '');
      throw new exception_1.ApiException(409, 'Conflict', body, response.headers);
    }
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'EmailSettings'), 'EmailSettings', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replacePreviewErrorPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ErrorPage', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replacePreviewSignInPage(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'SignInPage', '');
      return body;
  ...
  async uploadBrandThemeBackgroundImage(response) {
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ImageUploadResponse'), 'ImageUploadResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
