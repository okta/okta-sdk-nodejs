...
exports.DomainApiResponseProcessor = exports.DomainApiRequestFactory = void 0;
...
class DomainApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param certificate
     */
  async createCertificate(domainId, certificate, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'createCertificate', 'domainId');
    }
    // verify required parameter 'certificate' is not null or undefined
    if (certificate === null || certificate === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'createCertificate', 'certificate');
    }
    // Path Params
    const localVarPath = '/api/v1/domains/{domainId}/certificate'
  ...
  async createDomain(domain, _options) {
    ...
    if (domain === null || domain === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'createDomain', 'domain');
    }
    // Path Params
  ...
  async deleteDomain(domainId, _options) {
    ...
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'deleteDomain', 'domainId');
    }
    // Path Params
    const localVarPath = '/api/v1/domains/{domainId}'
      .replace('{' + 'domainId' + '}', encodeURIComponent(String(domainId)));
    // Make Request Context
  ...
  async getDomain(domainId, _options) {
    ...
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'getDomain', 'domainId');
    }
    // Path Params
    const localVarPath = '/api/v1/domains/{domainId}'
      .replace('{' + 'domainId' + '}', encodeURIComponent(String(domainId)));
  ...
  async verifyDomain(domainId, _options) {
    ...
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('DomainApi', 'verifyDomain', 'domainId');
    }
    // Path Params
    const localVarPath = '/api/v1/domains/{domainId}/verify'
      .replace('{' + 'domainId' + '}', encodeURIComponent(String(domainId)));
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethodEnum.POST);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
...
exports.DomainApiRequestFactory = DomainApiRequestFactory;
class DomainApiResponseProcessor {
  /**
     ...
     */
  async createCertificate(response) {
...
exports.DomainApiResponseProcessor = DomainApiResponseProcessor;
