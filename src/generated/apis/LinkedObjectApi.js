...
exports.LinkedObjectApiResponseProcessor = exports.LinkedObjectApiRequestFactory = void 0;
...
class LinkedObjectApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async createLinkedObjectDefinition(linkedObject, _options) {
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(linkedObject, 'LinkedObject', ''), contentType);
...
exports.LinkedObjectApiRequestFactory = LinkedObjectApiRequestFactory;
class LinkedObjectApiResponseProcessor {
  /**
  ...
  async createLinkedObjectDefinition(response) {
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'LinkedObject'), 'LinkedObject', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteLinkedObjectDefinition(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getLinkedObjectDefinition(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listLinkedObjectDefinitions(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<LinkedObject>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<LinkedObject>'), 'Array<LinkedObject>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
}
exports.LinkedObjectApiResponseProcessor = LinkedObjectApiResponseProcessor;
