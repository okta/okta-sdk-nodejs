...
exports.PushProviderApiResponseProcessor = exports.PushProviderApiRequestFactory = void 0;
...
class PushProviderApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param pushProvider
     */
  async createPushProvider(pushProvider, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'pushProvider' is not null or undefined
    if (pushProvider === null || pushProvider === undefined) {
      throw new baseapi_1.RequiredError('PushProviderApi', 'createPushProvider', 'pushProvider');
    }
    // Path Params
    const path = '/api/v1/push-providers';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(pushProvider, 'PushProvider', ''), contentType);
  ...
  /**
     ...
     */
  async deletePushProvider(pushProviderId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'pushProviderId' is not null or undefined
    if (pushProviderId === null || pushProviderId === undefined) {
      throw new baseapi_1.RequiredError('PushProviderApi', 'deletePushProvider', 'pushProviderId');
    }
    // Path Params
    const path = '/api/v1/push-providers/{pushProviderId}';
    const vars = {
      ['pushProviderId']: String(pushProviderId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param pushProviderId Id of the push provider
     */
  async getPushProvider(pushProviderId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'pushProviderId' is not null or undefined
    if (pushProviderId === null || pushProviderId === undefined) {
      throw new baseapi_1.RequiredError('PushProviderApi', 'getPushProvider', 'pushProviderId');
    }
    // Path Params
    const path = '/api/v1/push-providers/{pushProviderId}';
    const vars = {
  ...
  /**
     ...
     */
  async listPushProviders(type, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/push-providers';
    // Make Request Context
    ...
    // Query Params
    if (type !== undefined) {
      requestContext.setQueryParam('type', ObjectSerializer_1.ObjectSerializer.serialize(type, 'ProviderType', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
...
exports.PushProviderApiRequestFactory = PushProviderApiRequestFactory;
class PushProviderApiResponseProcessor {
  /**
     ...
     */
  async createPushProvider(response) {
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'PushProvider'), 'PushProvider', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deletePushProvider(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getPushProvider(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'PushProvider', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listPushProviders(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<PushProvider>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<PushProvider>'), 'Array<PushProvider>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
...
exports.PushProviderApiResponseProcessor = PushProviderApiResponseProcessor;
