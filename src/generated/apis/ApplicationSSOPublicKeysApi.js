...
exports.ApplicationSSOPublicKeysApiResponseProcessor = exports.ApplicationSSOPublicKeysApiRequestFactory = void 0;
 ...
 * no description
 */
class ApplicationSSOPublicKeysApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
  ...
  async activateOAuth2ClientJsonWebKey(appId, keyId, _options) {
    ...
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'activateOAuth2ClientJsonWebKey', 'appId');
    }
    // verify required parameter 'keyId' is not null or undefined
    if (keyId === null || keyId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'activateOAuth2ClientJsonWebKey', 'keyId');
    }
    // Path Params
  ...
  async activateOAuth2ClientSecret(appId, secretId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'activateOAuth2ClientSecret', 'appId');
    }
    // verify required parameter 'secretId' is not null or undefined
    if (secretId === null || secretId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'activateOAuth2ClientSecret', 'secretId');
    }
    // Path Params
  ...
  /**
     ...
     * @param addJwkRequest
     */
  async addJwk(appId, addJwkRequest, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'addJwk', 'appId');
    }
    // verify required parameter 'addJwkRequest' is not null or undefined
    if (addJwkRequest === null || addJwkRequest === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'addJwk', 'addJwkRequest');
    }
    // Path Params
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(addJwkRequest, 'AddJwkRequest', ''), contentType);
  ...
  async createOAuth2ClientSecret(appId, oAuth2ClientSecretRequestBody, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'createOAuth2ClientSecret', 'appId');
    }
    // Path Params
  ...
  async deactivateOAuth2ClientJsonWebKey(appId, keyId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deactivateOAuth2ClientJsonWebKey', 'appId');
    }
    // verify required parameter 'keyId' is not null or undefined
    if (keyId === null || keyId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deactivateOAuth2ClientJsonWebKey', 'keyId');
    }
    // Path Params
  ...
  async deactivateOAuth2ClientSecret(appId, secretId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deactivateOAuth2ClientSecret', 'appId');
    }
    // verify required parameter 'secretId' is not null or undefined
    if (secretId === null || secretId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deactivateOAuth2ClientSecret', 'secretId');
    }
    // Path Params
  ...
  async deleteOAuth2ClientSecret(appId, secretId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deleteOAuth2ClientSecret', 'appId');
    }
    // verify required parameter 'secretId' is not null or undefined
    if (secretId === null || secretId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deleteOAuth2ClientSecret', 'secretId');
    }
    // Path Params
  ...
  async deletejwk(appId, keyId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deletejwk', 'appId');
    }
    // verify required parameter 'keyId' is not null or undefined
    if (keyId === null || keyId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'deletejwk', 'keyId');
    }
    // Path Params
  ...
  async getJwk(appId, keyId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'getJwk', 'appId');
    }
    // verify required parameter 'keyId' is not null or undefined
    if (keyId === null || keyId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'getJwk', 'keyId');
    }
    // Path Params
    const path = '/api/v1/apps/{appId}/credentials/jwks/{keyId}';
    const vars = {
  ...
  async getOAuth2ClientSecret(appId, secretId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'getOAuth2ClientSecret', 'appId');
    }
    // verify required parameter 'secretId' is not null or undefined
    if (secretId === null || secretId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'getOAuth2ClientSecret', 'secretId');
    }
    // Path Params
    const path = '/api/v1/apps/{appId}/credentials/secrets/{secretId}';
    const vars = {
  ...
  async listJwk(appId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'listJwk', 'appId');
    }
    // Path Params
    const path = '/api/v1/apps/{appId}/credentials/jwks';
    const vars = {
  ...
  async listOAuth2ClientSecrets(appId, _options) {
    ...
    // verify required parameter 'appId' is not null or undefined
    if (appId === null || appId === undefined) {
      throw new baseapi_1.RequiredError('ApplicationSSOPublicKeysApi', 'listOAuth2ClientSecrets', 'appId');
    }
    // Path Params
    const path = '/api/v1/apps/{appId}/credentials/secrets';
    const vars = {
...
exports.ApplicationSSOPublicKeysApiRequestFactory = ApplicationSSOPublicKeysApiRequestFactory;
class ApplicationSSOPublicKeysApiResponseProcessor {
  /**
  ...
  async activateOAuth2ClientJsonWebKey(response) {
    ...
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ListJwk200ResponseKeysInner', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ListJwk200ResponseKeysInner'), 'ListJwk200ResponseKeysInner', '');
      return body;
    }
  ...
  async deactivateOAuth2ClientJsonWebKey(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'OAuth2ClientJsonSigningKeyResponse', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('400', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'OAuth2ClientJsonSigningKeyResponse'), 'OAuth2ClientJsonSigningKeyResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  async getJwk(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'GetJwk200Response', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('401', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'GetJwk200Response'), 'GetJwk200Response', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
...
exports.ApplicationSSOPublicKeysApiResponseProcessor = ApplicationSSOPublicKeysApiResponseProcessor;
