...
exports.DeviceApiResponseProcessor = exports.DeviceApiRequestFactory = void 0;
 ...
 * no description
 */
class DeviceApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     */
  async activateDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'activateDevice', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}/lifecycle/activate';
    const vars = {
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async deactivateDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'deactivateDevice', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}/lifecycle/deactivate';
    const vars = {
      ['deviceId']: String(deviceId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async deleteDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'deleteDevice', 'deviceId');
    }
    // Path Params
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async getDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'getDevice', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}';
    const vars = {
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async listDeviceUsers(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'listDeviceUsers', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}/users';
    const vars = {
      ['deviceId']: String(deviceId),
    };
    // Make Request Context
  ...
  /**
     ...
     */
  async listDevices(after, limit, search, expand, _options) {
    let _config = _options || this.configuration;
    // Path Params
    ...
    // Query Params
    if (expand !== undefined) {
      requestContext.setQueryParam('expand', ObjectSerializer_1.ObjectSerializer.serialize(expand, '\'user\' | \'userSummary\'', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async suspendDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'suspendDevice', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}/lifecycle/suspend';
    const vars = {
      ['deviceId']: String(deviceId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param deviceId &#x60;id&#x60; of the device
     */
  async unsuspendDevice(deviceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceId' is not null or undefined
    if (deviceId === null || deviceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceApi', 'unsuspendDevice', 'deviceId');
    }
    // Path Params
    const path = '/api/v1/devices/{deviceId}/lifecycle/unsuspend';
    const vars = {
      ['deviceId']: String(deviceId),
    };
    // Make Request Context
...
exports.DeviceApiRequestFactory = DeviceApiRequestFactory;
class DeviceApiResponseProcessor {
  /**
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deactivateDevice(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
  ...
  async getDevice(response) {
    ...
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Device', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Device'), 'Device', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listDeviceUsers(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<DeviceUser>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<DeviceUser>'), 'Array<DeviceUser>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listDevices(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<DeviceList>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<DeviceList>'), 'Array<DeviceList>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async unsuspendDevice(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
...
exports.DeviceApiResponseProcessor = DeviceApiResponseProcessor;
