...
exports.RiskEventApiResponseProcessor = exports.RiskEventApiRequestFactory = void 0;
 ...
 * no description
 */
class RiskEventApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param instance
     */
  async sendRiskEvents(instance, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'instance' is not null or undefined
    if (instance === null || instance === undefined) {
      throw new baseapi_1.RequiredError('RiskEventApi', 'sendRiskEvents', 'instance');
    }
    // Path Params
    const path = '/api/v1/risk/events/ip';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(instance, 'Array<RiskEvent>', ''), contentType);
...
exports.RiskEventApiRequestFactory = RiskEventApiRequestFactory;
class RiskEventApiResponseProcessor {
  /**
...
exports.RiskEventApiResponseProcessor = RiskEventApiResponseProcessor;
