...
exports.DeviceAssuranceApiResponseProcessor = exports.DeviceAssuranceApiRequestFactory = void 0;
...
class DeviceAssuranceApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     */
  async createDeviceAssurancePolicy(deviceAssurance, _options) {
    ...
    if (deviceAssurance === null || deviceAssurance === undefined) {
      throw new baseapi_1.RequiredError('DeviceAssuranceApi', 'createDeviceAssurancePolicy', 'deviceAssurance');
    }
    // Path Params
    const path = '/api/v1/device-assurances';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(deviceAssurance, 'DeviceAssurance', ''), contentType);
  ...
  /**
     ...
     */
  async deleteDeviceAssurancePolicy(deviceAssuranceId, _options) {
    let _config = _options || this.configuration;
    ...
    if (deviceAssuranceId === null || deviceAssuranceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceAssuranceApi', 'deleteDeviceAssurancePolicy', 'deviceAssuranceId');
    }
    // Path Params
    const path = '/api/v1/device-assurances/{deviceAssuranceId}';
    const vars = {
      ['deviceAssuranceId']: String(deviceAssuranceId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param deviceAssuranceId Id of the device assurance policy
     */
  async getDeviceAssurancePolicy(deviceAssuranceId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'deviceAssuranceId' is not null or undefined
    if (deviceAssuranceId === null || deviceAssuranceId === undefined) {
      throw new baseapi_1.RequiredError('DeviceAssuranceApi', 'getDeviceAssurancePolicy', 'deviceAssuranceId');
    }
    // Path Params
    const path = '/api/v1/device-assurances/{deviceAssuranceId}';
    const vars = {
...
exports.DeviceAssuranceApiRequestFactory = DeviceAssuranceApiRequestFactory;
class DeviceAssuranceApiResponseProcessor {
  /**
     ...
     */
  async createDeviceAssurancePolicy(response) {
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'DeviceAssurance'), 'DeviceAssurance', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteDeviceAssurancePolicy(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getDeviceAssurancePolicy(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DeviceAssurance', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listDeviceAssurancePolicies(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<DeviceAssurance>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<DeviceAssurance>'), 'Array<DeviceAssurance>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
...
exports.DeviceAssuranceApiResponseProcessor = DeviceAssuranceApiResponseProcessor;
