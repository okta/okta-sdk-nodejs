...
exports.RealmApiResponseProcessor = exports.RealmApiRequestFactory = void 0;
 ...
 * no description
 */
class RealmApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     * Creates a new realm
     * Create a realm
     * @param body
     */
  async createRealm(body, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new baseapi_1.RequiredError('RealmApi', 'createRealm', 'body');
    }
    // Path Params
    const path = '/api/v1/realms';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, 'CreateRealmRequest', ''), contentType);
  ...
  /**
     ...
     */
  async deleteRealm(realmId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'realmId' is not null or undefined
    if (realmId === null || realmId === undefined) {
      throw new baseapi_1.RequiredError('RealmApi', 'deleteRealm', 'realmId');
    }
    // Path Params
    const path = '/api/v1/realms/{realmId}';
    const vars = {
  ...
  /**
     ...
     * @param realmId ID of the realm
     */
  async getRealm(realmId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'realmId' is not null or undefined
    if (realmId === null || realmId === undefined) {
      throw new baseapi_1.RequiredError('RealmApi', 'getRealm', 'realmId');
    }
    // Path Params
    const path = '/api/v1/realms/{realmId}';
    const vars = {
  ...
  /**
     ...
     */
  async listRealms(limit, after, search, sortBy, sortOrder, _options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/realms';
    // Make Request Context
  ...
  /**
     ...
     * @param body
     */
  async replaceRealm(realmId, body, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'realmId' is not null or undefined
    if (realmId === null || realmId === undefined) {
      throw new baseapi_1.RequiredError('RealmApi', 'replaceRealm', 'realmId');
    }
    // verify required parameter 'body' is not null or undefined
    if (body === null || body === undefined) {
      throw new baseapi_1.RequiredError('RealmApi', 'replaceRealm', 'body');
    }
    // Path Params
    const path = '/api/v1/realms/{realmId}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, 'UpdateRealmRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
...
exports.RealmApiRequestFactory = RealmApiRequestFactory;
class RealmApiResponseProcessor {
  /**
     ...
     */
  async createRealm(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Realm', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Realm'), 'Realm', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listRealms(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<Realm>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'Array<Realm>'), 'Array<Realm>', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
...
exports.RealmApiResponseProcessor = RealmApiResponseProcessor;
