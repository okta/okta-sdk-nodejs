...
exports.ProfileMappingApiResponseProcessor = exports.ProfileMappingApiRequestFactory = void 0;
...
class ProfileMappingApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async listProfileMappings(after, limit, sourceId, targetId, _options) {
    ...
    if (sourceId !== undefined) {
      requestContext.setQueryParam('sourceId', ObjectSerializer_1.ObjectSerializer.serialize(sourceId, 'string', ''));
    }
    // Query Params
    if (targetId !== undefined) {
      requestContext.setQueryParam('targetId', ObjectSerializer_1.ObjectSerializer.serialize(targetId, 'string', ''));
    }
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     */
  async updateProfileMapping(mappingId, profileMapping, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'mappingId' is not null or undefined
    if (mappingId === null || mappingId === undefined) {
      throw new baseapi_1.RequiredError('ProfileMappingApi', 'updateProfileMapping', 'mappingId');
    }
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(profileMapping, 'ProfileMappingRequest', ''), contentType);
...
exports.ProfileMappingApiRequestFactory = ProfileMappingApiRequestFactory;
class ProfileMappingApiResponseProcessor {
  /**
     ...
     */
  async getProfileMapping(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ProfileMapping', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listProfileMappings(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<ListProfileMappings>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateProfileMapping(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ProfileMapping', '');
      return body;
...
exports.ProfileMappingApiResponseProcessor = ProfileMappingApiResponseProcessor;
