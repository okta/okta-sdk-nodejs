...
exports.OrgCreatorApiResponseProcessor = exports.OrgCreatorApiRequestFactory = void 0;
 ...
 * no description
 */
class OrgCreatorApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     ...
     * @param childOrg
     */
  async createChildOrg(childOrg, _options) {
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(childOrg, 'ChildOrg', ''), contentType);
...
exports.OrgCreatorApiRequestFactory = OrgCreatorApiRequestFactory;
class OrgCreatorApiResponseProcessor {
  /**
     ...
     */
  async createChildOrg(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('201', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ChildOrg', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ChildOrg'), 'ChildOrg', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
}
exports.OrgCreatorApiResponseProcessor = OrgCreatorApiResponseProcessor;
