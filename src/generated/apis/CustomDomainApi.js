...
exports.CustomDomainApiResponseProcessor = exports.CustomDomainApiRequestFactory = void 0;
 ...
 * no description
 */
class CustomDomainApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     * Creates your custom domain
     * Create a custom domain
     * @param domain
     */
  async createCustomDomain(domain, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domain' is not null or undefined
    if (domain === null || domain === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'createCustomDomain', 'domain');
    }
    // Path Params
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(domain, 'DomainRequest', ''), contentType);
  ...
  /**
     ...
     */
  async deleteCustomDomain(domainId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'deleteCustomDomain', 'domainId');
    }
    // Path Params
    const path = '/api/v1/domains/{domainId}';
    const vars = {
  ...
  /**
     ...
     * @param domainId &#x60;id&#x60; of the Domain
     */
  async getCustomDomain(domainId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'getCustomDomain', 'domainId');
    }
    // Path Params
    const path = '/api/v1/domains/{domainId}';
    const vars = {
  ...
  /**
     ...
     */
  async listCustomDomains(_options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/domains';
    // Make Request Context
  ...
  /**
     ...
     * @param updateDomain
     */
  async replaceCustomDomain(domainId, updateDomain, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'replaceCustomDomain', 'domainId');
    }
    // verify required parameter 'updateDomain' is not null or undefined
    if (updateDomain === null || updateDomain === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'replaceCustomDomain', 'updateDomain');
    }
    // Path Params
    const path = '/api/v1/domains/{domainId}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateDomain, 'UpdateDomain', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param certificate
     */
  async upsertCertificate(domainId, certificate, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'upsertCertificate', 'domainId');
    }
    // verify required parameter 'certificate' is not null or undefined
    if (certificate === null || certificate === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'upsertCertificate', 'certificate');
    }
    // Path Params
    const path = '/api/v1/domains/{domainId}/certificate';
    const vars = {
      ['domainId']: String(domainId),
    };
    // Make Request Context
  ...
  async verifyDomain(domainId, _options) {
    ...
    // verify required parameter 'domainId' is not null or undefined
    if (domainId === null || domainId === undefined) {
      throw new baseapi_1.RequiredError('CustomDomainApi', 'verifyDomain', 'domainId');
    }
    // Path Params
    const path = '/api/v1/domains/{domainId}/verify';
    const vars = {
      ['domainId']: String(domainId),
    };
    // Make Request Context
...
exports.CustomDomainApiRequestFactory = CustomDomainApiRequestFactory;
class CustomDomainApiResponseProcessor {
  /**
     ...
     */
  async createCustomDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DomainResponse', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'DomainResponse'), 'DomainResponse', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteCustomDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getCustomDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DomainResponse', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listCustomDomains(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DomainListResponse', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
    ...
    // Work around for missing responses in specification, e.g. for petstore.yaml
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'DomainListResponse'), 'DomainListResponse', '');
      return body;
    }
    throw new exception_1.ApiException(response.httpStatusCode, 'Unknown API Status Code!', await response.getBodyAsAny(), response.headers);
  }
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceCustomDomain(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DomainResponse', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async upsertCertificate(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('204', response.httpStatusCode)) {
      return;
    }
...
exports.CustomDomainApiResponseProcessor = CustomDomainApiResponseProcessor;
