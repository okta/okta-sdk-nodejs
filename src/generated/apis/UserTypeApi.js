...
exports.UserTypeApiResponseProcessor = exports.UserTypeApiRequestFactory = void 0;
...
class UserTypeApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async createUserType(userType, _options) {
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(userType, 'UserType', ''), contentType);
  ...
  /**
     ...
     * @param userType
     */
  async replaceUserType(typeId, userType, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'typeId' is not null or undefined
    if (typeId === null || typeId === undefined) {
      throw new baseapi_1.RequiredError('UserTypeApi', 'replaceUserType', 'typeId');
    }
    // Path Params
    const path = '/api/v1/meta/types/user/{typeId}';
    const vars = {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(userType, 'UserTypePutRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
  ...
  /**
     ...
     * @param userType
     */
  async updateUserType(typeId, userType, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'typeId' is not null or undefined
    if (typeId === null || typeId === undefined) {
      throw new baseapi_1.RequiredError('UserTypeApi', 'updateUserType', 'typeId');
    }
    // verify required parameter 'userType' is not null or undefined
    if (userType === null || userType === undefined) {
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(userType, 'UserTypePostRequest', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
...
exports.UserTypeApiRequestFactory = UserTypeApiRequestFactory;
class UserTypeApiResponseProcessor {
  /**
     ...
     */
  async createUserType(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'UserType', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listUserTypes(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<UserType>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceUserType(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'UserType', '');
      return body;
...
exports.UserTypeApiResponseProcessor = UserTypeApiResponseProcessor;
