...
exports.ThreatInsightApiResponseProcessor = exports.ThreatInsightApiRequestFactory = void 0;
...
class ThreatInsightApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async updateConfiguration(threatInsightConfiguration, _options) {
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(threatInsightConfiguration, 'ThreatInsightConfiguration', ''), contentType);
...
exports.ThreatInsightApiRequestFactory = ThreatInsightApiRequestFactory;
class ThreatInsightApiResponseProcessor {
  /**
     ...
     */
  async getCurrentConfiguration(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ThreatInsightConfiguration', '');
      return body;
    }
    ...
    if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType, 'ThreatInsightConfiguration'), 'ThreatInsightConfiguration', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateConfiguration(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ThreatInsightConfiguration', '');
      return body;
...
exports.ThreatInsightApiResponseProcessor = ThreatInsightApiResponseProcessor;
