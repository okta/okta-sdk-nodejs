...
exports.SchemaApiResponseProcessor = exports.SchemaApiRequestFactory = void 0;
...
class SchemaApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  ...
  async getLogStreamSchema(logStreamType, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'logStreamType' is not null or undefined
    if (logStreamType === null || logStreamType === undefined) {
      throw new baseapi_1.RequiredError('SchemaApi', 'getLogStreamSchema', 'logStreamType');
    }
    // Path Params
    const path = '/api/v1/meta/schemas/logStream/{logStreamType}';
    const vars = {
      ['logStreamType']: String(logStreamType),
    };
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(path, http_1.HttpMethodEnum.GET, vars);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
  ...
  async listLogStreamSchemas(_options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/meta/schemas/logStream';
    // Make Request Context
    const requestContext = _config.baseServer.makeRequestContext(path, http_1.HttpMethodEnum.GET);
    requestContext.setHeaderParam('Accept', 'application/json, */*;q=0.8');
    let authMethod;
  ...
  async updateApplicationUserProfile(appInstanceId, body, _options) {
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, 'UserSchema', ''), contentType);
  ...
  async updateUserProfile(schemaId, userSchema, _options) {
    ...
    // verify required parameter 'schemaId' is not null or undefined
    if (schemaId === null || schemaId === undefined) {
      throw new baseapi_1.RequiredError('SchemaApi', 'updateUserProfile', 'schemaId');
    }
    ...
    requestContext.setHeaderParam('Content-Type', contentType);
    requestContext.setHeaderParam('Content-Transfer-Encoding', contentEncoding);
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(userSchema, 'UserSchema', ''), contentType);
    requestContext.setBody(serializedBody);
    let authMethod;
    // Apply auth methods
    authMethod = _config.authMethods['apiToken'];
...
class SchemaApiResponseProcessor {
  /**
     ...
     */
  async getApplicationUserSchema(response) {
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getLogStreamSchema(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listLogStreamSchemas(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateApplicationUserProfile(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'UserSchema', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async updateGroupSchema(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'GroupSchema', '');
      return body;
...
exports.SchemaApiResponseProcessor = SchemaApiResponseProcessor;
