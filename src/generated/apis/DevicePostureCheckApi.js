...
exports.DevicePostureCheckApiResponseProcessor = exports.DevicePostureCheckApiRequestFactory = void 0;
 ...
 * no description
 */
class DevicePostureCheckApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
  /**
     * Creates a device posture check
     * Create a device posture check
     * @param devicePostureCheck
     */
  async createDevicePostureCheck(devicePostureCheck, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'devicePostureCheck' is not null or undefined
    if (devicePostureCheck === null || devicePostureCheck === undefined) {
      throw new baseapi_1.RequiredError('DevicePostureCheckApi', 'createDevicePostureCheck', 'devicePostureCheck');
    }
    // Path Params
    const path = '/api/v1/device-posture-checks';
    ...
    const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(devicePostureCheck, 'DevicePostureCheck', ''), contentType);
  ...
  /**
     ...
     */
  async deleteDevicePostureCheck(postureCheckId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'postureCheckId' is not null or undefined
    if (postureCheckId === null || postureCheckId === undefined) {
      throw new baseapi_1.RequiredError('DevicePostureCheckApi', 'deleteDevicePostureCheck', 'postureCheckId');
    }
    // Path Params
    const path = '/api/v1/device-posture-checks/{postureCheckId}';
    const vars = {
      ['postureCheckId']: String(postureCheckId),
    };
    // Make Request Context
  ...
  /**
     ...
     * @param postureCheckId ID of the device posture check
     */
  async getDevicePostureCheck(postureCheckId, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'postureCheckId' is not null or undefined
    if (postureCheckId === null || postureCheckId === undefined) {
      throw new baseapi_1.RequiredError('DevicePostureCheckApi', 'getDevicePostureCheck', 'postureCheckId');
    }
    // Path Params
    const path = '/api/v1/device-posture-checks/{postureCheckId}';
    const vars = {
  ...
  /**
     ...
     */
  async listDefaultDevicePostureChecks(_options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/device-posture-checks/default';
    // Make Request Context
  ...
  /**
     ...
     */
  async listDevicePostureChecks(_options) {
    let _config = _options || this.configuration;
    // Path Params
    const path = '/api/v1/device-posture-checks';
    // Make Request Context
  ...
  /**
     ...
     * @param devicePostureCheck
     */
  async replaceDevicePostureCheck(postureCheckId, devicePostureCheck, _options) {
    let _config = _options || this.configuration;
    // verify required parameter 'postureCheckId' is not null or undefined
    if (postureCheckId === null || postureCheckId === undefined) {
      throw new baseapi_1.RequiredError('DevicePostureCheckApi', 'replaceDevicePostureCheck', 'postureCheckId');
    }
    // verify required parameter 'devicePostureCheck' is not null or undefined
    if (devicePostureCheck === null || devicePostureCheck === undefined) {
      throw new baseapi_1.RequiredError('DevicePostureCheckApi', 'replaceDevicePostureCheck', 'devicePostureCheck');
    }
    // Path Params
    const path = '/api/v1/device-posture-checks/{postureCheckId}';
    const vars = {
...
exports.DevicePostureCheckApiRequestFactory = DevicePostureCheckApiRequestFactory;
class DevicePostureCheckApiResponseProcessor {
  /**
     ...
     */
  async createDevicePostureCheck(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DevicePostureCheck', '');
      return body;
    }
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async deleteDevicePostureCheck(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async getDevicePostureCheck(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DevicePostureCheck', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listDefaultDevicePostureChecks(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<DevicePostureCheck>', '');
      return body;
    }
    if ((0, util_1.isCodeInRange)('403', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'ModelError', '');
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async listDevicePostureChecks(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'Array<DevicePostureCheck>', '');
      return body;
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  async replaceDevicePostureCheck(response) {
    const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers['content-type']);
    if ((0, util_1.isCodeInRange)('200', response.httpStatusCode)) {
      const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), 'DevicePostureCheck', '');
      return body;
...
exports.DevicePostureCheckApiResponseProcessor = DevicePostureCheckApiResponseProcessor;
