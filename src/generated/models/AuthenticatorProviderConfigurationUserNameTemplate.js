...
class AuthenticatorProviderConfigurationUserNameTemplate {
  ...
  static getAttributeTypeMap() {
    return AuthenticatorProviderConfigurationUserNameTemplate.attributeTypeMap;
  }
}
exports.AuthenticatorProviderConfigurationUserNameTemplate = AuthenticatorProviderConfigurationUserNameTemplate;
AuthenticatorProviderConfigurationUserNameTemplate.discriminator = undefined;
AuthenticatorProviderConfigurationUserNameTemplate.attributeTypeMap = [
  {
    'name': 'template',
    'baseName': 'template',
    'type': 'string',
