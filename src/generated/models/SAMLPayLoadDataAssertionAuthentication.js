...
exports.SAMLPayLoadDataAssertionAuthentication = void 0;
/**
...
SAMLPayLoadDataAssertionAuthentication.discriminator = undefined;
SAMLPayLoadDataAssertionAuthentication.attributeTypeMap = [
  {
    'name': 'sessionIndex',
    'baseName': 'sessionIndex',
    'type': 'string',
    'format': ''
  },
  {
    'name': 'authnContext',
    'baseName': 'authnContext',
    'type': 'SAMLPayLoadDataAssertionAuthenticationAuthnContext',
    'format': ''
  }
];
