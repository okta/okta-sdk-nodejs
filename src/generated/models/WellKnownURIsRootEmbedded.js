...
WellKnownURIsRootEmbedded.discriminator = undefined;
WellKnownURIsRootEmbedded.attributeTypeMap = [
  {
    'name': 'apple_app_site_association',
    'baseName': 'apple-app-site-association',
    'type': 'WellKnownURIsRootEmbeddedAppleAppSiteAssociation',
    'format': ''
  },
  {
    'name': 'assetlinks_json',
    'baseName': 'assetlinks.json',
    'type': 'WellKnownURIsRootEmbeddedAssetlinksJson',
    'format': ''
  },
  {
    'name': 'webauthn',
