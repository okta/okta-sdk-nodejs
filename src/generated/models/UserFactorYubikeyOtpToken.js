...
UserFactorYubikeyOtpToken.discriminator = undefined;
UserFactorYubikeyOtpToken.attributeTypeMap = [
  {
    'name': 'created',
    'baseName': 'created',
    'type': 'Date',
  ...
  },
  {
    'name': 'status',
    'baseName': 'status',
    'type': 'UserFactorYubikeyOtpTokenStatusEnum',
    'format': ''
  },
  {
    'name': '_embedded',
