...
exports.LogStreamLinksSelfAndLifecycle = void 0;
/**
...
class LogStreamLinksSelfAndLifecycle {
  ...
  static getAttributeTypeMap() {
    return LogStreamLinksSelfAndLifecycle.attributeTypeMap;
  }
}
exports.LogStreamLinksSelfAndLifecycle = LogStreamLinksSelfAndLifecycle;
LogStreamLinksSelfAndLifecycle.discriminator = undefined;
LogStreamLinksSelfAndLifecycle.attributeTypeMap = [
  {
    'name': 'activate',
    'baseName': 'activate',
    'type': 'LogStreamActivateLink',
    'format': ''
  },
  {
    'name': 'deactivate',
    'baseName': 'deactivate',
    'type': 'LogStreamDeactivateLink',
    'format': ''
  },
  {
    'name': 'self',
    'baseName': 'self',
    'type': 'LogStreamSelfLink',
    'format': ''
  }
];
