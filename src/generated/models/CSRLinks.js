...
class CSRLinks {
  ...
  static getAttributeTypeMap() {
    return CSRLinks.attributeTypeMap;
  }
}
exports.CSRLinks = CSRLinks;
CSRLinks.discriminator = undefined;
CSRLinks.attributeTypeMap = [
  {
    'name': 'publish',
    'baseName': 'publish',
    'type': 'HrefCsrPublishLink',
    'format': ''
  },
  {
    'name': 'self',
    'baseName': 'self',
    'type': 'HrefCsrSelfLink',
    'format': ''
  }
];
