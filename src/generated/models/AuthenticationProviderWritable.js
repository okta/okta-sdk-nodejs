...
exports.AuthenticationProviderWritable = void 0;
/**
...
AuthenticationProviderWritable.discriminator = undefined;
AuthenticationProviderWritable.attributeTypeMap = [
  {
    'name': 'name',
    'baseName': 'name',
    'type': 'string',
  ...
  },
  {
    'name': 'type',
    'baseName': 'type',
    'type': 'AuthenticationProviderTypeWritable',
    'format': ''
  }
];
