...
exports.UserImportRequestDataContextApplication = void 0;
/**
...
UserImportRequestDataContextApplication.discriminator = undefined;
UserImportRequestDataContextApplication.attributeTypeMap = [
  {
    'name': 'name',
    'baseName': 'name',
    'type': 'string',
  ...
  },
  {
    'name': 'status',
    'baseName': 'status',
    'type': 'UserImportRequestDataContextApplicationStatusEnum',
    'format': ''
  }
];
