...
exports.AuthenticatorMethodConstraint = void 0;
/**
...
AuthenticatorMethodConstraint.discriminator = undefined;
AuthenticatorMethodConstraint.attributeTypeMap = [
  {
    'name': 'allowedAuthenticators',
    'baseName': 'allowedAuthenticators',
    'type': 'Array<AuthenticatorIdentity>',
    'format': ''
  },
  {
    'name': 'method',
    'baseName': 'method',
    'type': 'AuthenticatorMethodConstraintMethodEnum',
    'format': ''
  }
];
