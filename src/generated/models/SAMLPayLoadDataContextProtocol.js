...
exports.SAMLPayLoadDataContextProtocol = void 0;
/**
...
SAMLPayLoadDataContextProtocol.discriminator = undefined;
SAMLPayLoadDataContextProtocol.attributeTypeMap = [
  {
    'name': 'type',
    'baseName': 'type',
    'type': 'string',
  ...
  },
  {
    'name': 'issuer',
    'baseName': 'issuer',
    'type': 'SAMLPayLoadDataContextProtocolIssuer',
    'format': ''
  }
];
