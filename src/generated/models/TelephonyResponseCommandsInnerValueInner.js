...
TelephonyResponseCommandsInnerValueInner.discriminator = undefined;
TelephonyResponseCommandsInnerValueInner.attributeTypeMap = [
  {
    'name': 'status',
    'baseName': 'status',
    'type': 'TelephonyResponseCommandsInnerValueInnerStatusEnum',
    'format': ''
  },
  {
    'name': 'provider',
