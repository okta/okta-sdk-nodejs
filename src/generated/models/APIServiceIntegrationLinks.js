...
exports.APIServiceIntegrationLinks = void 0;
/**
...
class APIServiceIntegrationLinks {
  static getAttributeTypeMap() {
    return APIServiceIntegrationLinks.attributeTypeMap;
  }
  constructor() {
  }
}
exports.APIServiceIntegrationLinks = APIServiceIntegrationLinks;
APIServiceIntegrationLinks.discriminator = undefined;
APIServiceIntegrationLinks.attributeTypeMap = [
  {
    'name': 'client',
    'baseName': 'client',
    'type': 'HrefObjectClientLink',
    'format': ''
  },
  {
    'name': 'logo',
    'baseName': 'logo',
    'type': 'HrefObjectLogoLink',
    'format': ''
  },
  {
    'name': 'self',
