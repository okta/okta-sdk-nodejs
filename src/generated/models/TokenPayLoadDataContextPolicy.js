...
exports.TokenPayLoadDataContextPolicy = void 0;
/**
...
TokenPayLoadDataContextPolicy.discriminator = undefined;
TokenPayLoadDataContextPolicy.attributeTypeMap = [
  {
    'name': 'id',
    'baseName': 'id',
    'type': 'string',
  ...
  },
  {
    'name': 'rule',
    'baseName': 'rule',
    'type': 'TokenPayLoadDataContextPolicyRule',
    'format': ''
  }
];
