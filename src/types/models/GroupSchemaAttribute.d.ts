...
declare class GroupSchemaAttribute extends Resource {
...
type GroupSchemaAttributeOptions = OptionalKnownProperties<GroupSchemaAttribute>;

export {
  GroupSchemaAttribute,
  GroupSchemaAttributeOptions
};
