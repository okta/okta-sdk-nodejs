...
type PasswordPolicyRecoveryEmailPropertiesOptions = OptionalKnownProperties<PasswordPolicyRecoveryEmailProperties>;

export {
  PasswordPolicyRecoveryEmailProperties,
  PasswordPolicyRecoveryEmailPropertiesOptions
};
