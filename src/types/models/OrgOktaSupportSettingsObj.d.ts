...
declare class OrgOktaSupportSettingsObj extends Resource {
...
type OrgOktaSupportSettingsObjOptions = OptionalKnownProperties<OrgOktaSupportSettingsObj>;

export {
  OrgOktaSupportSettingsObj,
  OrgOktaSupportSettingsObjOptions
};
