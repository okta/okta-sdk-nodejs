...
export declare class UserApiRequestFactory extends BaseAPIRequestFactory {
  ...
  /**
     ...
     */
  listUsers(contentType?: string, search?: string, filter?: string, q?: string, after?: string, limit?: number, sortBy?: string, sortOrder?: string, fields?: string, expand?: string, _options?: Configuration): Promise<RequestContext>;
  /**
  ...
  /**
     ...
     */
  revokeUserSessions(userId: string, oauthTokens?: boolean, forgetDevices?: boolean, _options?: Configuration): Promise<RequestContext>;
  /**
