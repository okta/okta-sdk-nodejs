...
export declare class BehaviorApiRequestFactory extends BaseAPIRequestFactory {
  ...
  /**
     ...
     * @param rule
     */
  updateBehaviorDetectionRule(behaviorId: string, rule: BehaviorRule, _options?: Configuration): Promise<RequestContext>;
}
export declare class BehaviorApiResponseProcessor {
  ...
  /**
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
  updateBehaviorDetectionRule(response: ResponseContext): Promise<BehaviorRule>;
}
