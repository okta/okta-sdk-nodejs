...
export declare class PromiseAgentConnectionsApi {
  private api;
  ...
  /**
      ...
      */
  activateManagedConnection(agentId: string, connectionId: string, _options?: Configuration): Promise<ManagedConnection>;
  /**
      ...
      */
  createManagedConnection(agentId: string, managedConnectionCreatable: ManagedConnectionCreatable, _options?: Configuration): Promise<ManagedConnection>;
  /**
      ...
      * @param connectionId ID of the connection
      */
  deactivateManagedConnection(agentId: string, connectionId: string, _options?: Configuration): Promise<ManagedConnection>;
  /**
      ...
      * @param connectionId ID of the connection
      */
  deleteManagedConnection(agentId: string, connectionId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param connectionId ID of the connection
      */
  getManagedConnection(agentId: string, connectionId: string, _options?: Configuration): Promise<ManagedConnection>;
  /**
      ...
      */
  listConnections(agentId: string, after?: string, limit?: number, _options?: Configuration): Promise<ManagedConnectionList>;
  /**
      ...
      */
  updateManagedConnection(agentId: string, connectionId: string, managedConnectionPatchable: ManagedConnectionPatchable, _options?: Configuration): Promise<ManagedConnection>;
}
...
export declare class PromiseAgentPoolsApi {
  ...
  /**
      ...
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listAgentPools(limitPerPoolType?: number, poolType?: AgentType, after?: string, _options?: Configuration): Promise<Collection<AgentPool>>;
  /**
...
export declare class PromiseAgentPotentialConnectionsApi {
  private api;
  ...
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listPotentialConnectionsByType(filter: string, match?: string, after?: string, limit?: number, _options?: Configuration): Promise<PotentialConnectionList>;
}
import { AgentPublicKeyApiRequestFactory, AgentPublicKeyApiResponseProcessor } from '../apis/AgentPublicKeyApi';
export declare class PromiseAgentPublicKeyApi {
  private api;
  ...
  /**
      ...
      */
  activateAgentJsonWebKey(agentId: string, keyId: string, _options?: Configuration): Promise<AgentJsonSigningKeyResponse>;
  /**
      ...
      */
  addAgentJwk(agentId: string, agentJsonSigningKeyRequest: AgentJsonSigningKeyRequest, _options?: Configuration): Promise<AgentJsonSigningKeyResponse>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the AI agent JSON Web Key
      */
  deactivateAgentJsonWebKey(agentId: string, keyId: string, _options?: Configuration): Promise<AgentJsonSigningKeyResponse>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the AI agent JSON Web Key
      */
  deleteAgentJwk(agentId: string, keyId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the AI agent JSON Web Key
      */
  getAgentJwk(agentId: string, keyId: string, _options?: Configuration): Promise<AgentJsonSigningKeyResponse>;
  /**
      * Lists all JSON Web Keys (JWK) for an AI agent
      * List all AI agent JSON Web Keys
      * @param agentId ID of the AI agent
      */
  listAgentJwk(agentId: string, _options?: Configuration): Promise<ListAgentJwk200Response>;
}
import { AgentRegistrationApiRequestFactory, AgentRegistrationApiResponseProcessor } from '../apis/AgentRegistrationApi';
export declare class PromiseAgentRegistrationApi {
  private api;
  ...
  /**
      ...
      * @param agentId ID of the AI agent
      */
  activateAIAgent(agentId: string, _options?: Configuration): Promise<void>;
  /**
      * Deactivates an AI agent
      * Deactivate an AI agent
      * @param agentId ID of the AI agent
      */
  deactivateAIAgent(agentId: string, _options?: Configuration): Promise<void>;
  /**
      * Deletes an AI agent
      * Delete an AI agent
      * @param agentId ID of the AI agent
      */
  deleteAIAgent(agentId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves an AI agent
      * Retrieve an AI agent
      * @param agentId ID of the AI agent
      */
  getAIAgent(agentId: string, _options?: Configuration): Promise<AIAgent>;
  /**
      ...
      */
  getAIAgentOperation(operationId: string, _options?: Configuration): Promise<AIAgentOperationResponse>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listAIAgentOperations(after?: string, limit?: number, _options?: Configuration): Promise<AIAgentOperationListResponse>;
  /**
      * Lists all AI agents
      * List all AI agents
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      ...
      */
  listAIAgents(after?: string, limit?: number, search?: string, _options?: Configuration): Promise<ListAIAgents200Response>;
  /**
      * Registers an AI agent
      * Register an AI agent
      * @param body
      */
  registerAIAgent(body: CreateAIAgentRequest, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param body
      */
  replaceAIAgent(agentId: string, body: UpdateAIAgentRequest, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param body
      */
  updateAIAgent(agentId: string, body: PatchAIAgentRequest, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseApiServiceIntegrationsApi {
  private api;
  ...
  /**
      ...
      */
  activateApiServiceIntegrationInstanceSecret(apiServiceId: string, secretId: string, _options?: Configuration): Promise<APIServiceIntegrationInstanceSecret>;
  /**
      ...
      */
  createApiServiceIntegrationInstance(postAPIServiceIntegrationInstanceRequest: PostAPIServiceIntegrationInstanceRequest, _options?: Configuration): Promise<PostAPIServiceIntegrationInstance>;
  /**
      ...
      * @param apiServiceId &#x60;id&#x60; of the API Service Integration instance
      */
  createApiServiceIntegrationInstanceSecret(apiServiceId: string, _options?: Configuration): Promise<APIServiceIntegrationInstanceSecret>;
  /**
      ...
      * @param secretId &#x60;id&#x60; of the API Service Integration instance Secret
      */
  deactivateApiServiceIntegrationInstanceSecret(apiServiceId: string, secretId: string, _options?: Configuration): Promise<APIServiceIntegrationInstanceSecret>;
  /**
      ...
      * @param apiServiceId &#x60;id&#x60; of the API Service Integration instance
      */
  deleteApiServiceIntegrationInstance(apiServiceId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param secretId &#x60;id&#x60; of the API Service Integration instance Secret
      */
  deleteApiServiceIntegrationInstanceSecret(apiServiceId: string, secretId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves an API Service Integration instance by `id`
      * Retrieve an API service integration instance
      * @param apiServiceId &#x60;id&#x60; of the API Service Integration instance
      */
  getApiServiceIntegrationInstance(apiServiceId: string, _options?: Configuration): Promise<APIServiceIntegrationInstance>;
  /**
      ...
      * @param apiServiceId &#x60;id&#x60; of the API Service Integration instance
      */
  listApiServiceIntegrationInstanceSecrets(apiServiceId: string, _options?: Configuration): Promise<Collection<APIServiceIntegrationInstanceSecret>>;
  /**
      * Lists all API Service Integration instances with a pagination option
      * List all API service integration instances
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listApiServiceIntegrationInstances(after?: string, _options?: Configuration): Promise<Collection<APIServiceIntegrationInstance>>;
}
...
export declare class PromiseApiTokenApi {
  ...
  /**
      ...
      */
  listApiTokens(_options?: Configuration): Promise<Collection<ApiToken>>;
  /**
  ...
  /**
      ...
      */
  upsertApiToken(apiTokenId: string, apiTokenUpdate: ApiTokenUpdate, _options?: Configuration): Promise<ApiToken>;
}
...
export declare class PromiseApplicationApi {
  ...
  /**
      ...
      */
  assignApplicationPolicy(appId: string, policyId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  assignGroupToApplication(appId: string, groupId: string, applicationGroupAssignment?: ApplicationGroupAssignment, _options?: Configuration): Promise<ApplicationGroupAssignment>;
  /**
      ...
      * @param appUser
      */
  assignUserToApplication(appId: string, appUser: AppUserAssignRequest, _options?: Configuration): Promise<AppUser>;
  /**
  ...
  /**
      ...
      */
  configureCapabilityApplication(appId: string, capabilityType: CapabilityType, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  createApplication(application: Application, activate?: boolean, oktaAccessGatewayAgent?: string, _options?: Configuration): Promise<Application>;
  /**
      ...
      */
  createFederatedClaim(appId: string, federatedClaimRequestBody: FederatedClaimRequestBody, _options?: Configuration): Promise<FederatedClaim>;
  /**
  ...
  /**
      ...
      */
  deleteFederatedClaim(appId: string, claimId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param metadata
      */
  generateCsrForApplication(appId: string, metadata: CsrMetadata, _options?: Configuration): Promise<string>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  getDefaultProvisioningConnectionForApplication(appId: string, _options?: Configuration): Promise<ProvisioningConnectionResponse>;
  /**
      ...
      */
  getFeatureForApplication(appId: string, name: ApplicationFeatureType, _options?: Configuration): Promise<ApplicationFeature>;
  /**
      ...
      * @param claimId The unique &#x60;id&#x60; of the federated claim
      */
  getFederatedClaim(appId: string, claimId: string, _options?: Configuration): Promise<FederatedClaimRequestBody>;
  /**
      ...
      */
  getOAuth2AccessTokenForExpressConfiguration(appId: string, token?: string, capabilityType?: CapabilityType, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  getOAuth2TokenForApplication(appId: string, tokenId: string, expand?: string, _options?: Configuration): Promise<OAuth2RefreshToken>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  getUserProvisioningConnectionJWKS(appId: string, _options?: Configuration): Promise<AppConnectionUserProvisionJWKResponse>;
  /**
  ...
  /**
      ...
      * @param expand An optional query parameter to return the corresponding [User](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/User/) object in the &#x60;_embedded&#x60; property. Valid value: &#x60;user&#x60;
      */
  listApplicationUsers(appId: string, after?: string, limit?: number, q?: string, expand?: string, _options?: Configuration): Promise<Collection<AppUser>>;
  /**
      ...
      */
  listApplications(q?: string, after?: string, useOptimization?: boolean, alwaysIncludeVpnSettings?: boolean, limit?: number, filter?: string, expand?: string, includeNonDeleted?: boolean, _options?: Configuration): Promise<Collection<Application>>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  listFederatedClaims(appId: string, _options?: Configuration): Promise<Collection<FederatedClaim>>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listOAuth2TokensForApplication(appId: string, expand?: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<OAuth2RefreshToken>>;
  /**
  ...
  /**
      ...
      * @param kid
      */
  previewSAMLmetadataForApplication(appId: string, kid: string, _options?: Configuration): Promise<string>;
  /**
  ...
  /**
      ...
      * @param application
      */
  replaceApplication(appId: string, application: Application, _options?: Configuration): Promise<Application>;
  /**
      ...
      */
  replaceFederatedClaim(appId: string, claimId: string, federatedClaim?: FederatedClaim, _options?: Configuration): Promise<FederatedClaim>;
  /**
  ...
  /**
      ...
      * @param groupId The &#x60;id&#x60; of the group
      */
  unassignApplicationFromGroup(appId: string, groupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  unassignUserFromApplication(appId: string, userId: string, sendEmail?: boolean, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appUser
      */
  updateApplicationUser(appId: string, userId: string, appUser: AppUserUpdateRequest, _options?: Configuration): Promise<AppUser>;
  /**
      ...
      */
  updateDefaultProvisioningConnectionForApplication(appId: string, provisioningConnectionRequest: UpdateDefaultProvisioningConnectionForApplicationRequest, activate?: boolean, _options?: Configuration): Promise<ProvisioningConnectionResponse>;
  /**
      ...
      */
  updateFeatureForApplication(appId: string, name: ApplicationFeatureType, capabilitiesObject: UpdateFeatureForApplicationRequest, _options?: Configuration): Promise<ApplicationFeature>;
  /**
      ...
      */
  updateGroupAssignmentToApplication(appId: string, groupId: string, jsonPatchOperation?: Array<JsonPatchOperation>, _options?: Configuration): Promise<ApplicationGroupAssignment>;
  /**
  ...
  /**
      ...
      * @param state
      */
  verifyProvisioningConnectionForApplication(appName: OAuthProvisioningEnabledApp, appId: string, code?: string, state?: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param state
      */
  verifyProvisioningConnectionForGoogleApplication(appId: string, code?: string, state?: string, _options?: Configuration): Promise<void>;
  /**
...
export declare class PromiseApplicationCrossAppAccessConnectionsApi {
  private api;
  ...
  /**
      ...
      */
  createCrossAppAccessConnection(appId: string, orgCrossAppAccessConnection: OrgCrossAppAccessConnection, _options?: Configuration): Promise<OrgCrossAppAccessConnection>;
  /**
      ...
      */
  deleteCrossAppAccessConnection(appId: string, connectionId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  getAllCrossAppAccessConnections(appId: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<OrgCrossAppAccessConnection>>;
  /**
      ...
      * @param connectionId Connection ID
      */
  getCrossAppAccessConnection(appId: string, connectionId: string, _options?: Configuration): Promise<OrgCrossAppAccessConnection>;
  /**
      ...
      */
  updateCrossAppAccessConnection(appId: string, connectionId: string, orgCrossAppAccessConnectionPatchRequest: OrgCrossAppAccessConnectionPatchRequest, _options?: Configuration): Promise<OrgCrossAppAccessConnection>;
}
...
export declare class PromiseApplicationInterclientTrustMappingsApi {
  private api;
  ...
  /**
      ...
      */
  createInterclientTrustMapping(appId: string, interclientTrustMappingRequestBody: InterclientTrustMappingRequestBody, _options?: Configuration): Promise<InterclientTrustMapping>;
  /**
      ...
      */
  deleteInterclientTrustMapping(appId: string, allowedAppId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appId Application ID
      */
  listInterclientAllowedApplications(appId: string, _options?: Configuration): Promise<Collection<string>>;
  /**
      ...
      * @param appId Application ID
      */
  listInterclientTargetApplications(appId: string, _options?: Configuration): Promise<Collection<string>>;
}
...
export declare class PromiseApplicationSSOPublicKeysApi {
  private api;
  ...
  /**
      ...
      */
  activateOAuth2ClientJsonWebKey(appId: string, keyId: string, _options?: Configuration): Promise<ListJwk200ResponseKeysInner>;
  /**
      ...
      */
  activateOAuth2ClientSecret(appId: string, secretId: string, _options?: Configuration): Promise<OAuth2ClientSecret>;
  /**
      ...
      * @param addJwkRequest
      */
  addJwk(appId: string, addJwkRequest: AddJwkRequest, _options?: Configuration): Promise<ListJwk200ResponseKeysInner>;
  /**
  ...
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the OAuth 2.0 Client JSON Web Key
      */
  deactivateOAuth2ClientJsonWebKey(appId: string, keyId: string, _options?: Configuration): Promise<OAuth2ClientJsonSigningKeyResponse>;
  /**
      ...
      * @param secretId Unique &#x60;id&#x60; of the OAuth 2.0 Client Secret
      */
  deactivateOAuth2ClientSecret(appId: string, secretId: string, _options?: Configuration): Promise<OAuth2ClientSecret>;
  /**
      ...
      * @param secretId Unique &#x60;id&#x60; of the OAuth 2.0 Client Secret
      */
  deleteOAuth2ClientSecret(appId: string, secretId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the OAuth 2.0 Client JSON Web Key
      */
  deletejwk(appId: string, keyId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the OAuth 2.0 Client JSON Web Key
      */
  getJwk(appId: string, keyId: string, _options?: Configuration): Promise<GetJwk200Response>;
  /**
      ...
      * @param secretId Unique &#x60;id&#x60; of the OAuth 2.0 Client Secret
      */
  getOAuth2ClientSecret(appId: string, secretId: string, _options?: Configuration): Promise<OAuth2ClientSecret>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  listOAuth2ClientSecrets(appId: string, _options?: Configuration): Promise<Collection<OAuth2ClientSecret>>;
}
...
export declare class PromiseAttackProtectionApi {
  ...
  /**
      ...
      */
  getAuthenticatorSettings(_options?: Configuration): Promise<AttackProtectionAuthenticatorSettings>;
  /**
      * Retrieves the User Lockout Settings for an org
      * Retrieve the user lockout settings
      */
  getUserLockoutSettings(_options?: Configuration): Promise<UserLockoutSettings>;
  /**
      * Replaces the Authenticator Settings for an org
      * Replace the authenticator settings
      * @param authenticatorSettings
      */
  replaceAuthenticatorSettings(authenticatorSettings: AttackProtectionAuthenticatorSettings, _options?: Configuration): Promise<AttackProtectionAuthenticatorSettings>;
  /**
      * Replaces the User Lockout Settings for an org
      * Replace the user lockout settings
      * @param lockoutSettings
      */
  replaceUserLockoutSettings(lockoutSettings: UserLockoutSettings, _options?: Configuration): Promise<UserLockoutSettings>;
}
...
export declare class PromiseAuthenticatorApi {
  ...
  /**
      ...
      */
  activateAuthenticator(authenticatorId: string, _options?: Configuration): Promise<AuthenticatorBase>;
  /**
      ...
      */
  activateAuthenticatorMethod(authenticatorId: string, methodType: AuthenticatorMethodType, _options?: Configuration): Promise<AuthenticatorMethodBase>;
  /**
  ...
  /**
      ...
      * @param authenticatorId &#x60;id&#x60; of the authenticator
      */
  deactivateAuthenticator(authenticatorId: string, _options?: Configuration): Promise<AuthenticatorBase>;
  /**
  ...
  /**
      ...
      * @param authenticatorId &#x60;id&#x60; of the authenticator
      */
  getAuthenticator(authenticatorId: string, _options?: Configuration): Promise<AuthenticatorBase>;
  /**
  ...
  /**
      ...
      * @param authenticatorId &#x60;id&#x60; of the authenticator
      */
  listAuthenticatorMethods(authenticatorId: string, _options?: Configuration): Promise<Collection<AuthenticatorMethodBase>>;
  /**
      * Lists all authenticators
      * List all authenticators
      */
  listAuthenticators(_options?: Configuration): Promise<Collection<AuthenticatorBase>>;
  /**
      ...
      * @param authenticator
      */
  replaceAuthenticator(authenticatorId: string, authenticator: AuthenticatorBase, _options?: Configuration): Promise<AuthenticatorBase>;
  /**
  ...
  /**
      ...
      */
  verifyRpIdDomain(authenticatorId: string, webAuthnMethodType: AuthenticatorMethodTypeWebAuthn, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseAuthorizationServerApi {
  ...
  /**
      ...
      */
  createAssociatedServers(authServerId: string, associatedServerMediated: AssociatedServerMediated, _options?: Configuration): Promise<Collection<AuthorizationServer>>;
  /**
  ...
  /**
      ...
      * @param policy
      */
  createAuthorizationServerPolicy(authServerId: string, policy: AuthorizationServerPolicy, _options?: Configuration): Promise<AuthorizationServerPolicy>;
  /**
      ...
      * @param policyRule
      */
  createAuthorizationServerPolicyRule(authServerId: string, policyId: string, policyRule: AuthorizationServerPolicyRuleRequest, _options?: Configuration): Promise<AuthorizationServerPolicyRule>;
  /**
      ...
      * @param oAuth2Claim
      */
  createOAuth2Claim(authServerId: string, oAuth2Claim: OAuth2Claim, _options?: Configuration): Promise<OAuth2Claim>;
  /**
      ...
      * @param oAuth2Scope
      */
  createOAuth2Scope(authServerId: string, oAuth2Scope: OAuth2Scope, _options?: Configuration): Promise<OAuth2Scope>;
  /**
  ...
  /**
      ...
      */
  deleteAssociatedServer(authServerId: string, associatedServerId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param ruleId &#x60;id&#x60; of the policy rule
      */
  deleteAuthorizationServerPolicyRule(authServerId: string, policyId: string, ruleId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      */
  getAuthorizationServerKey(authServerId: string, keyId: string, _options?: Configuration): Promise<AuthorizationServerJsonWebKey>;
  /**
      * Retrieves a policy
      * Retrieve a policy
      * @param authServerId &#x60;id&#x60; of the Authorization Server
  ...
  /**
      ...
      * @param ruleId &#x60;id&#x60; of the policy rule
      */
  getAuthorizationServerPolicyRule(authServerId: string, policyId: string, ruleId: string, _options?: Configuration): Promise<AuthorizationServerPolicyRule>;
  /**
  ...
  /**
      ...
      */
  listAssociatedServersByTrustedType(authServerId: string, trusted?: boolean, q?: string, limit?: number, after?: string, _options?: Configuration): Promise<Collection<AuthorizationServer>>;
  /**
      * Lists all of the current, future, and expired Keys used by the Custom Authorization Server
      * List all credential keys
      * @param authServerId &#x60;id&#x60; of the Authorization Server
      */
  listAuthorizationServerKeys(authServerId: string, _options?: Configuration): Promise<Collection<AuthorizationServerJsonWebKey>>;
  /**
      * Lists all policies
      * List all policies
      * @param authServerId &#x60;id&#x60; of the Authorization Server
  ...
  /**
      ...
      * @param policyId &#x60;id&#x60; of the Policy
      */
  listAuthorizationServerPolicyRules(authServerId: string, policyId: string, _options?: Configuration): Promise<Collection<AuthorizationServerPolicyRule>>;
  /**
      ...
      */
  listAuthorizationServers(q?: string, limit?: number, after?: string, _options?: Configuration): Promise<Collection<AuthorizationServer>>;
  /**
  ...
  /**
      ...
      */
  listOAuth2Scopes(authServerId: string, q?: string, filter?: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<OAuth2Scope>>;
  /**
  ...
  /**
      ...
      * @param authorizationServer
      */
  replaceAuthorizationServer(authServerId: string, authorizationServer: AuthorizationServer, _options?: Configuration): Promise<AuthorizationServer>;
  /**
      * Replaces a policy
      * Replace a policy
      * @param authServerId &#x60;id&#x60; of the Authorization Server
      ...
      * @param policy
      */
  replaceAuthorizationServerPolicy(authServerId: string, policyId: string, policy: AuthorizationServerPolicy, _options?: Configuration): Promise<AuthorizationServerPolicy>;
  /**
      ...
      * @param policyRule
      */
  replaceAuthorizationServerPolicyRule(authServerId: string, policyId: string, ruleId: string, policyRule: AuthorizationServerPolicyRuleRequest, _options?: Configuration): Promise<AuthorizationServerPolicyRule>;
  /**
      ...
      * @param oAuth2Claim
      */
  replaceOAuth2Claim(authServerId: string, claimId: string, oAuth2Claim: OAuth2Claim, _options?: Configuration): Promise<OAuth2Claim>;
  /**
      ...
      * @param oAuth2Scope
      */
  replaceOAuth2Scope(authServerId: string, scopeId: string, oAuth2Scope: OAuth2Scope, _options?: Configuration): Promise<OAuth2Scope>;
  /**
  ...
  /**
      ...
      * @param use
      */
  rotateAuthorizationServerKeys(authServerId: string, use: JwkUse, _options?: Configuration): Promise<Collection<AuthorizationServerJsonWebKey>>;
}
...
export declare class PromiseBehaviorApi {
  ...
  /**
      ...
      * @param rule
      */
  replaceBehaviorDetectionRule(behaviorId: string, rule: BehaviorRule, _options?: Configuration): Promise<BehaviorRule>;
}
...
export declare class PromiseCAPTCHAApi {
  ...
  /**
      ...
      */
  deleteOrgCaptchaSettings(_options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      */
  getOrgCaptchaSettings(_options?: Configuration): Promise<OrgCAPTCHASettings>;
  /**
  ...
  /**
      ...
      * @param instance
      */
  replaceCaptchaInstance(captchaId: string, instance: CAPTCHAInstance, _options?: Configuration): Promise<CAPTCHAInstance>;
  /**
      ...
      */
  replacesOrgCaptchaSettings(orgCAPTCHASettings: OrgCAPTCHASettings, _options?: Configuration): Promise<OrgCAPTCHASettings>;
  /**
...
export declare class PromiseCustomDomainApi {
  private api;
  ...
  /**
      ...
      * @param domain
      */
  createCustomDomain(domain: DomainRequest, _options?: Configuration): Promise<DomainResponse>;
  /**
      * Deletes a custom domain by `domainId`
      * Delete a custom domain
      * @param domainId &#x60;id&#x60; of the Domain
      */
  deleteCustomDomain(domainId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a custom domain by `domainId`
      * Retrieve a custom domain
      * @param domainId &#x60;id&#x60; of the Domain
      */
  getCustomDomain(domainId: string, _options?: Configuration): Promise<DomainResponse>;
  /**
      * Lists all verified custom domains for the org
      * List all custom domains
      */
  listCustomDomains(_options?: Configuration): Promise<DomainListResponse>;
  /**
      ...
      * @param updateDomain
      */
  replaceCustomDomain(domainId: string, updateDomain: UpdateDomain, _options?: Configuration): Promise<DomainResponse>;
  /**
      ...
      * @param certificate
      */
  upsertCertificate(domainId: string, certificate: DomainCertificate, _options?: Configuration): Promise<void>;
  /**
...
export declare class PromiseCustomRoleApi {
  private api;
  ...
  /**
      ...
      * @param instance
      */
  createRole(instance: CreateIamRoleRequest, _options?: Configuration): Promise<IamRole>;
  /**
      ...
      * @param instance
      */
  createRolePermission(roleIdOrLabel: string, permissionType: string, instance?: CreateUpdateIamRolePermissionRequest, _options?: Configuration): Promise<void>;
  /**
      * Deletes a custom role by `roleIdOrLabel`
      * Delete a custom role
      * @param roleIdOrLabel &#x60;id&#x60; or &#x60;label&#x60; of the role
      */
  deleteRole(roleIdOrLabel: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param permissionType An Okta [permission](https://developer.okta.com/docs/api/openapi/okta-management/guides/permissions)
      */
  deleteRolePermission(roleIdOrLabel: string, permissionType: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a role by `roleIdOrLabel`
      * Retrieve a role
      * @param roleIdOrLabel &#x60;id&#x60; or &#x60;label&#x60; of the role
      */
  getRole(roleIdOrLabel: string, _options?: Configuration): Promise<IamRole>;
  /**
      ...
      * @param permissionType An Okta [permission](https://developer.okta.com/docs/api/openapi/okta-management/guides/permissions)
      */
  getRolePermission(roleIdOrLabel: string, permissionType: string, _options?: Configuration): Promise<Permission>;
  /**
      * Lists all permissions for a custom role by `roleIdOrLabel`
      * List all custom role permissions
      * @param roleIdOrLabel &#x60;id&#x60; or &#x60;label&#x60; of the role
      */
  listRolePermissions(roleIdOrLabel: string, _options?: Configuration): Promise<Permissions>;
  /**
      * Lists all custom roles with pagination support
      * List all custom roles
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listRoles(after?: string, _options?: Configuration): Promise<IamRoles>;
  /**
      ...
      * @param instance
      */
  replaceRole(roleIdOrLabel: string, instance: UpdateIamRoleRequest, _options?: Configuration): Promise<IamRole>;
  /**
      ...
      * @param instance
      */
  replaceRolePermission(roleIdOrLabel: string, permissionType: string, instance?: CreateUpdateIamRolePermissionRequest, _options?: Configuration): Promise<Permission>;
}
...
export declare class PromiseCustomTelephonyProviderApi {
  private api;
  ...
  /**
      ...
      */
  activateCustomTelephonyCredential(customTelephonyProviderId: string, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
  /**
      ...
      */
  createCustomTelephonyProviderCredentials(customTelephonyProviderCredentialCreateRequest: CustomTelephonyProviderCredentialCreateRequest, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
  /**
      ...
      * @param customTelephonyProviderId The ID of the custom telephony provider
      */
  deactivateCustomTelephonyCredential(customTelephonyProviderId: string, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
  /**
      ...
      * @param customTelephonyProviderId The ID of the custom telephony provider
      */
  deleteCustomTelephonyProviderCredential(customTelephonyProviderId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves the details of a custom telephony provider by its ID
      * Retrieve a custom telephony provider
      * @param customTelephonyProviderId The ID of the custom telephony provider
      */
  getCustomTelephonyProviderCredential(customTelephonyProviderId: string, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
  /**
      * Lists all custom telephony providers that are configured in your org
      * List all custom telephony providers
      */
  listAllCustomTelephonyProviderCredentials(_options?: Configuration): Promise<CustomTelephonyProviderCredentialsResponse>;
  /**
      ...
      */
  sendTestCustomTelephonyProviderCredential(customTelephonyProviderId: string, customTelephonyProviderCredentialSendTestRequest: CustomTelephonyProviderCredentialSendTestRequest, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param customTelephonyProviderId The ID of the custom telephony provider
      */
  setAsPrimaryCustomTelephonyCredential(customTelephonyProviderId: string, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
  /**
      ...
      */
  updateCustomTelephonyProviderCredential(customTelephonyProviderId: string, customTelephonyProviderCredentialUpdateRequest: CustomTelephonyProviderCredentialUpdateRequest, _options?: Configuration): Promise<CustomTelephonyProviderCredentialResponse>;
}
...
export declare class PromiseCustomizationApi {
  ...
  /**
      ...
      */
  createBrand(createBrandRequest?: CreateBrandRequest, _options?: Configuration): Promise<Brand>;
  /**
  ...
  /**
      ...
      * @param brandId The ID of the brand
      */
  deleteBrand(brandId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param brandId The ID of the brand
      */
  deleteCustomizedErrorPage(brandId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param brandId The ID of the brand
      */
  deleteCustomizedSignInPage(brandId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param brandId The ID of the brand
      */
  deletePreviewErrorPage(brandId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param brandId The ID of the brand
      */
  deletePreviewSignInPage(brandId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  getBrand(brandId: string, expand?: Array<'themes' | 'domains' | 'emailDomain'>, _options?: Configuration): Promise<BrandWithEmbedded>;
  /**
  ...
  /**
      ...
      * @param templateName The name of the email template
      */
  getEmailSettings(brandId: string, templateName: string, _options?: Configuration): Promise<EmailSettingsResponse>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  getEmailTemplate(brandId: string, templateName: string, expand?: Array<'settings' | 'customizationCount'>, _options?: Configuration): Promise<EmailTemplateResponse>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  getErrorPage(brandId: string, expand?: Array<'default' | 'customized' | 'customizedUrl' | 'preview' | 'previewUrl'>, _options?: Configuration): Promise<PageRoot>;
  /**
      ...
      * @param brandId The ID of the brand
      */
  getPreviewErrorPage(brandId: string, _options?: Configuration): Promise<ErrorPage>;
  /**
      ...
      * @param brandId The ID of the brand
      */
  getPreviewSignInPage(brandId: string, _options?: Configuration): Promise<SignInPage>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  getSignInPage(brandId: string, expand?: Array<'default' | 'customized' | 'customizedUrl' | 'preview' | 'previewUrl'>, _options?: Configuration): Promise<PageRoot>;
  /**
      * Retrieves the sign-out page settings
      * Retrieve the sign-out page settings
      * @param brandId The ID of the brand
      */
  getSignOutPageSettings(brandId: string, _options?: Configuration): Promise<HostedPage>;
  /**
      * Lists all sign-in widget versions supported by the current org
      * List all Sign-In Widget versions
      * @param brandId The ID of the brand
      */
  listAllSignInWidgetVersions(brandId: string, _options?: Configuration): Promise<Collection<string>>;
  /**
      * Lists all domains associated with a brand by `brandId`
      * List all domains associated with a brand
      * @param brandId The ID of the brand
      */
  listBrandDomains(brandId: string, _options?: Configuration): Promise<BrandDomains>;
  /**
  ...
  /**
      ...
      */
  listBrands(expand?: Array<'themes' | 'domains' | 'emailDomain'>, after?: string, limit?: number, q?: string, _options?: Configuration): Promise<Collection<BrandWithEmbedded>>;
  /**
  ...
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  listEmailTemplates(brandId: string, after?: string, limit?: number, expand?: Array<'settings' | 'customizationCount'>, _options?: Configuration): Promise<Collection<EmailTemplateResponse>>;
  /**
      ...
      * @param brand
      */
  replaceBrand(brandId: string, brand: BrandRequest, _options?: Configuration): Promise<Brand>;
  /**
      ...
      * @param theme
      */
  replaceBrandTheme(brandId: string, themeId: string, theme: UpdateThemeRequest, _options?: Configuration): Promise<ThemeResponse>;
  /**
      ...
      * @param errorPage
      */
  replaceCustomizedErrorPage(brandId: string, errorPage: ErrorPage, _options?: Configuration): Promise<ErrorPage>;
  /**
      ...
      * @param signInPage
      */
  replaceCustomizedSignInPage(brandId: string, signInPage: SignInPage, _options?: Configuration): Promise<SignInPage>;
  /**
      ...
      */
  replaceEmailCustomization(brandId: string, templateName: string, customizationId: string, instance?: EmailCustomization, _options?: Configuration): Promise<EmailCustomization>;
  /**
      ...
      * @param emailSettings
      */
  replaceEmailSettings(brandId: string, templateName: string, emailSettings?: EmailSettings, _options?: Configuration): Promise<EmailSettings>;
  /**
      ...
      * @param errorPage
      */
  replacePreviewErrorPage(brandId: string, errorPage: ErrorPage, _options?: Configuration): Promise<ErrorPage>;
  /**
      ...
      * @param signInPage
      */
  replacePreviewSignInPage(brandId: string, signInPage: SignInPage, _options?: Configuration): Promise<SignInPage>;
  /**
  ...
  /**
      ...
      * @param file
      */
  uploadBrandThemeBackgroundImage(brandId: string, themeId: string, file: HttpFile, _options?: Configuration): Promise<ImageUploadResponse>;
  /**
      ...
      * @param file
      */
  uploadBrandThemeFavicon(brandId: string, themeId: string, file: HttpFile, _options?: Configuration): Promise<ImageUploadResponse>;
  /**
      ...
      * @param file
      */
  uploadBrandThemeLogo(brandId: string, themeId: string, file: HttpFile, _options?: Configuration): Promise<ImageUploadResponse>;
}
...
export declare class PromiseDeviceApi {
  ...
  /**
      ...
      */
  activateDevice(deviceId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param deviceId &#x60;id&#x60; of the device
      */
  deactivateDevice(deviceId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param deviceId &#x60;id&#x60; of the device
      */
  deleteDevice(deviceId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a device by `deviceId`
      * Retrieve a device
      * @param deviceId &#x60;id&#x60; of the device
      */
  getDevice(deviceId: string, _options?: Configuration): Promise<Device>;
  /**
      * Lists all Users for a device by `deviceId`
      * List all users for a device
      * @param deviceId &#x60;id&#x60; of the device
      */
  listDeviceUsers(deviceId: string, _options?: Configuration): Promise<Collection<DeviceUser>>;
  /**
      ...
      */
  listDevices(after?: string, limit?: number, search?: string, expand?: 'user' | 'userSummary', _options?: Configuration): Promise<Collection<DeviceList>>;
  /**
...
export declare class PromiseDeviceAccessApi {
  ...
  /**
      ...
      */
  getDesktopMFAEnforceNumberMatchingChallengeOrgSetting(_options?: Configuration): Promise<DesktopMFAEnforceNumberMatchingChallengeOrgSetting>;
  /**
      ...
      */
  getDesktopMFARecoveryPinOrgSetting(_options?: Configuration): Promise<DesktopMFARecoveryPinOrgSetting>;
  /**
      ...
      */
  replaceDesktopMFAEnforceNumberMatchingChallengeOrgSetting(desktopMFAEnforceNumberMatchingChallengeOrgSetting: DesktopMFAEnforceNumberMatchingChallengeOrgSetting, _options?: Configuration): Promise<DesktopMFAEnforceNumberMatchingChallengeOrgSetting>;
  /**
      ...
      */
  replaceDesktopMFARecoveryPinOrgSetting(desktopMFARecoveryPinOrgSetting: DesktopMFARecoveryPinOrgSetting, _options?: Configuration): Promise<DesktopMFARecoveryPinOrgSetting>;
}
import { DeviceAssuranceApiRequestFactory, DeviceAssuranceApiResponseProcessor } from '../apis/DeviceAssuranceApi';
export declare class PromiseDeviceAssuranceApi {
  private api;
  ...
  /**
      ...
      */
  createDeviceAssurancePolicy(deviceAssurance: DeviceAssurance, _options?: Configuration): Promise<DeviceAssurance>;
  /**
      ...
      */
  deleteDeviceAssurancePolicy(deviceAssuranceId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a device assurance policy by `deviceAssuranceId`
      * Retrieve a device assurance policy
      * @param deviceAssuranceId Id of the device assurance policy
      */
  getDeviceAssurancePolicy(deviceAssuranceId: string, _options?: Configuration): Promise<DeviceAssurance>;
  /**
      * Lists all device assurance policies
      * List all device assurance policies
      */
  listDeviceAssurancePolicies(_options?: Configuration): Promise<Collection<DeviceAssurance>>;
  /**
      ...
      * @param deviceAssurance
      */
  replaceDeviceAssurancePolicy(deviceAssuranceId: string, deviceAssurance: DeviceAssurance, _options?: Configuration): Promise<DeviceAssurance>;
}
import { DeviceIntegrationsApiRequestFactory, DeviceIntegrationsApiResponseProcessor } from '../apis/DeviceIntegrationsApi';
export declare class PromiseDeviceIntegrationsApi {
  private api;
  ...
  /**
      ...
      */
  activateDeviceIntegration(deviceIntegrationId: string, _options?: Configuration): Promise<DeviceIntegrations>;
  /**
      * Deactivates a device integration by `deviceIntegrationId`
      * Deactivate a device integration
      * @param deviceIntegrationId The ID of the device integration
      */
  deactivateDeviceIntegration(deviceIntegrationId: string, _options?: Configuration): Promise<DeviceIntegrations>;
  /**
      * Retrieves a device integration by `deviceIntegrationId`
      * Retrieve a device integration
      * @param deviceIntegrationId The ID of the device integration
      */
  getDeviceIntegration(deviceIntegrationId: string, _options?: Configuration): Promise<DeviceIntegrations>;
  /**
      ...
      */
  listDeviceIntegrations(_options?: Configuration): Promise<Collection<DeviceIntegrations>>;
}
import { DevicePostureCheckApiRequestFactory, DevicePostureCheckApiResponseProcessor } from '../apis/DevicePostureCheckApi';
export declare class PromiseDevicePostureCheckApi {
  private api;
  ...
  /**
      ...
      */
  createDevicePostureCheck(devicePostureCheck: DevicePostureCheck, _options?: Configuration): Promise<DevicePostureCheck>;
  /**
      ...
      */
  deleteDevicePostureCheck(postureCheckId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a device posture check by `postureCheckId`
      * Retrieve a device posture check
      * @param postureCheckId ID of the device posture check
      */
  getDevicePostureCheck(postureCheckId: string, _options?: Configuration): Promise<DevicePostureCheck>;
  /**
      ...
      */
  listDefaultDevicePostureChecks(_options?: Configuration): Promise<Collection<DevicePostureCheck>>;
  /**
      * Lists all device posture checks
      * List all device posture checks
      */
  listDevicePostureChecks(_options?: Configuration): Promise<Collection<DevicePostureCheck>>;
  /**
      ...
      * @param devicePostureCheck
      */
  replaceDevicePostureCheck(postureCheckId: string, devicePostureCheck: DevicePostureCheck, _options?: Configuration): Promise<DevicePostureCheck>;
}
...
export declare class PromiseDirectoriesIntegrationApi {
  private api;
  ...
  /**
      ...
      * @param agentAction
      */
  updateGroupMembership(appInstanceId: string, agentAction: AgentAction, _options?: Configuration): Promise<void>;
}
import { DisasterRecoveryApiRequestFactory, DisasterRecoveryApiResponseProcessor } from '../apis/DisasterRecoveryApi';
export declare class PromiseDisasterRecoveryApi {
  private api;
  ...
  /**
      ...
      */
  getDRStatus(_options?: Configuration): Promise<GetDRStatus200Response>;
  /**
      ...
      */
  getDRStatusForDomain(domain: string, _options?: Configuration): Promise<GetDRStatus200Response>;
  /**
      ...
      */
  startOrgFailback(startOrgFailbackRequest?: StartOrgFailbackRequest, _options?: Configuration): Promise<StartOrgFailback200Response>;
  /**
      ...
      */
  startOrgFailover(startOrgFailoverRequest?: StartOrgFailoverRequest, _options?: Configuration): Promise<StartOrgFailover200Response>;
}
import { EmailDomainApiRequestFactory, EmailDomainApiResponseProcessor } from '../apis/EmailDomainApi';
export declare class PromiseEmailDomainApi {
  private api;
  ...
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  createEmailDomain(emailDomain: EmailDomain, expand?: Array<'brands'>, _options?: Configuration): Promise<EmailDomainResponse>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  deleteEmailDomain(emailDomainId: string, expand?: Array<'brands'>, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  getEmailDomain(emailDomainId: string, expand?: Array<'brands'>, _options?: Configuration): Promise<EmailDomainResponseWithEmbedded>;
  /**
      * Lists all the Email Domains in your org
      * List all email domains
      * @param expand Specifies additional metadata to be included in the response
      */
  listEmailDomains(expand?: Array<'brands'>, _options?: Configuration): Promise<Collection<EmailDomainResponseWithEmbedded>>;
  /**
      ...
      * @param expand Specifies additional metadata to be included in the response
      */
  replaceEmailDomain(emailDomainId: string, updateEmailDomain: UpdateEmailDomain, expand?: Array<'brands'>, _options?: Configuration): Promise<EmailDomainResponse>;
  /**
      * Verifies an Email Domain by `emailDomainId`
      * Verify an email domain
      * @param emailDomainId
      */
  verifyEmailDomain(emailDomainId: string, _options?: Configuration): Promise<EmailDomainResponse>;
}
import { EmailServerApiRequestFactory, EmailServerApiResponseProcessor } from '../apis/EmailServerApi';
export declare class PromiseEmailServerApi {
  private api;
  ...
  /**
      ...
      */
  createEmailServer(emailServerPost?: EmailServerPost, _options?: Configuration): Promise<EmailServerResponse>;
  /**
      * Deletes the specified custom SMTP server configuration
      * Delete an SMTP server configuration
      * @param emailServerId
      */
  deleteEmailServer(emailServerId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      */
  listEmailServers(_options?: Configuration): Promise<EmailServerListResponse>;
  /**
      ...
      */
  testEmailServer(emailServerId: string, emailTestAddresses?: EmailTestAddresses, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  updateEmailServer(emailServerId: string, emailServerRequest?: EmailServerRequest, _options?: Configuration): Promise<EmailServerResponse>;
}
...
export declare class PromiseEventHookApi {
  ...
  /**
      ...
      * @param eventHook
      */
  replaceEventHook(eventHookId: string, eventHook: EventHook, _options?: Configuration): Promise<EventHook>;
  /**
...
export declare class PromiseFeatureApi {
  ...
  /**
      ...
      */
  updateFeatureLifecycle(featureId: string, lifecycle: FeatureLifecycle, mode?: string, _options?: Configuration): Promise<Feature>;
}
import { GovernanceBundleApiRequestFactory, GovernanceBundleApiResponseProcessor } from '../apis/GovernanceBundleApi';
export declare class PromiseGovernanceBundleApi {
  private api;
  ...
  /**
      ...
      */
  createGovernanceBundle(governanceBundleCreateRequest: GovernanceBundleCreateRequest, _options?: Configuration): Promise<GovernanceBundle>;
  /**
      * Deletes an Admin Console governance bundle
      * Delete a governance bundle
      * @param bundleId The &#x60;id&#x60; of a bundle
      */
  deleteGovernanceBundle(bundleId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a governance bundle for the Admin Console
      * Retrieve a governance bundle
      * @param bundleId The &#x60;id&#x60; of a bundle
      */
  getGovernanceBundle(bundleId: string, _options?: Configuration): Promise<GovernanceBundle>;
  /**
      * Retrieves the entitlement management opt-in status for the Admin Console
      * Retrieve the Admin Console opt-in status
      */
  getOptInStatus(_options?: Configuration): Promise<OptInStatusResponse>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listBundleEntitlementValues(bundleId: string, entitlementId: string, after?: string, limit?: number, _options?: Configuration): Promise<EntitlementValuesResponse>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listBundleEntitlements(bundleId: string, after?: string, limit?: number, _options?: Configuration): Promise<BundleEntitlementsResponse>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listGovernanceBundles(after?: string, limit?: number, _options?: Configuration): Promise<GovernanceBundlesResponse>;
  /**
      * Opts in the Admin Console to entitlement management
      * Opt in the Admin Console to entitlement management
      */
  optIn(_options?: Configuration): Promise<OptInStatusResponse>;
  /**
      * Opts out the Admin Console from entitlement management
      * Opt out the Admin Console from entitlement management
      */
  optOut(_options?: Configuration): Promise<OptInStatusResponse>;
  /**
      ...
      */
  replaceGovernanceBundle(bundleId: string, governanceBundleUpdateRequest: GovernanceBundleUpdateRequest, _options?: Configuration): Promise<GovernanceBundle>;
}
...
export declare class PromiseGroupApi {
  ...
  /**
      ...
      * @param groupOwner
      */
  assignGroupOwner(groupId: string, groupOwner: AssignGroupOwnerRequestBody, _options?: Configuration): Promise<GroupOwner>;
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  assignUserToGroup(groupId: string, userId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param group
      */
  createGroup(group: CreateGroupRequest, _options?: Configuration): Promise<Group>;
  /**
      ...
      * @param groupRule
      */
  createGroupRule(groupRule: CreateGroupRuleRequest, _options?: Configuration): Promise<GroupRule>;
  /**
  ...
  /**
      ...
      */
  deleteGroupOwner(groupId: string, ownerId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      */
  listGroupOwners(groupId: string, search?: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<GroupOwner>>;
  /**
  ...
  /**
      ...
      */
  listGroups(search?: string, filter?: string, q?: string, after?: string, limit?: number, expand?: string, sortBy?: string, sortOrder?: string, _options?: Configuration): Promise<Collection<Group>>;
  /**
      ...
      * @param group
      */
  replaceGroup(groupId: string, group: CreateGroupRequest, _options?: Configuration): Promise<Group>;
  /**
      ...
      * @param groupRule
      */
  replaceGroupRule(ruleId: string, groupRule: GroupRule, _options?: Configuration): Promise<GroupRule>;
  /**
...
export declare class PromiseHookKeyApi {
  ...
  /**
      ...
      * @param keyRequest
      */
  createHookKey(keyRequest: KeyRequest, _options?: Configuration): Promise<DetailedHookKeyInstance>;
  /**
      ...
      */
  deleteHookKey(hookKeyId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param hookKeyId ID of the Hook Key
      */
  getHookKey(hookKeyId: string, _options?: Configuration): Promise<HookKey>;
  /**
      * Retrieves a public key by `keyId`  >**Note:** keyId is the alias of the public key.
      * Retrieve a public key
      * @param keyId id\&quot; of the Public Key
      */
  getPublicKey(keyId: string, _options?: Configuration): Promise<Embedded>;
  /**
      * Lists all keys
      * List all keys
      */
  listHookKeys(_options?: Configuration): Promise<Collection<HookKey>>;
  /**
      ...
      * @param keyRequest
      */
  replaceHookKey(hookKeyId: string, keyRequest: KeyRequest, _options?: Configuration): Promise<DetailedHookKeyInstance>;
}
...
export declare class PromiseIdentityProviderApi {
  ...
  /**
      ...
      * @param jsonWebKey
      */
  createIdentityProviderKey(jsonWebKey: IdPCertificateCredential, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
  ...
  /**
      ...
      * @param metadata
      */
  generateCsrForIdentityProvider(idpId: string, metadata: CsrMetadata, _options?: Configuration): Promise<IdPCsr>;
  /**
      ...
      */
  generateIdentityProviderSigningKey(idpId: string, validityYears: number, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
      ...
      */
  getCsrForIdentityProvider(idpId: string, csrId: string, _options?: Configuration): Promise<IdPCsr>;
  /**
  ...
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the IdP key credential
      */
  getIdentityProviderKey(keyId: string, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
      * Retrieves a specific identity provider (IdP) key credential by `kid`
      ...
      * @param keyId Unique &#x60;id&#x60; of the IdP key credential
      */
  getIdentityProviderSigningKey(idpId: string, keyId: string, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
  ...
  /**
      ...
      * @param idpId &#x60;id&#x60; of IdP
      */
  listActiveIdentityProviderSigningKey(idpId: string, _options?: Configuration): Promise<Collection<IdPKeyCredential>>;
  /**
      * Lists all certificate signing requests (CSRs) for an identity provider (IdP)
      * List all certificate signing requests
      * @param idpId &#x60;id&#x60; of IdP
      */
  listCsrsForIdentityProvider(idpId: string, _options?: Configuration): Promise<Collection<IdPCsr>>;
  /**
      ...
      */
  listIdentityProviderApplicationUsers(idpId: string, q?: string, after?: string, limit?: number, expand?: string, _options?: Configuration): Promise<Collection<IdentityProviderApplicationUser>>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listIdentityProviderKeys(after?: string, limit?: number, _options?: Configuration): Promise<Collection<IdPKeyCredential>>;
  /**
      * Lists all signing key credentials for an identity provider (IdP)
      * List all signing key credentials for IdP
      * @param idpId &#x60;id&#x60; of IdP
      */
  listIdentityProviderSigningKeys(idpId: string, _options?: Configuration): Promise<Collection<IdPKeyCredential>>;
  /**
      ...
      */
  listIdentityProviders(q?: string, after?: string, limit?: number, type?: IdentityProviderType, _options?: Configuration): Promise<Collection<IdentityProvider>>;
  /**
  ...
  /**
      ...
      * @param body
      */
  publishCsrForIdentityProvider(idpId: string, csrId: string, body: HttpFile, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
      ...
      */
  replaceIdentityProvider(idpId: string, identityProvider: IdentityProvider, _options?: Configuration): Promise<IdentityProvider>;
  /**
      ...
      */
  replaceIdentityProviderKey(keyId: string, idPKeyCredential: IdPKeyCredential, _options?: Configuration): Promise<IdPKeyCredential>;
  /**
...
export declare class PromiseIdentitySourceApi {
  private api;
  ...
  /**
      ...
      */
  createIdentitySourceGroups(identitySourceId: string, groupsRequestSchema?: GroupsRequestSchema, _options?: Configuration): Promise<GroupsResponseSchema>;
  /**
      ...
      */
  createIdentitySourceGroupsMemberships(identitySourceId: string, groupOrExternalId: string, membershipRequestSchema?: MembershipRequestSchema, _options?: Configuration): Promise<void>;
  /**
      * Creates an identity source session for the given identity source instance
      * Create an identity source session
      * @param identitySourceId The ID of the identity source for which the session is created
      */
  createIdentitySourceSession(identitySourceId: string, _options?: Configuration): Promise<IdentitySourceSession>;
  /**
      ...
      */
  createIdentitySourceUser(identitySourceId: string, userRequestSchema?: UserRequestSchema, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupOrExternalId The Okta group ID or external ID of the identity source group
      */
  deleteIdentitySourceGroup(identitySourceId: string, groupOrExternalId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  deleteIdentitySourceGroupMemberships(identitySourceId: string, groupOrExternalId: string, memberExternalId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  deleteIdentitySourceSession(identitySourceId: string, sessionId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  deleteIdentitySourceUser(identitySourceId: string, externalId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupOrExternalId The Okta group ID or external ID of the identity source group
      */
  getIdentitySourceGroup(identitySourceId: string, groupOrExternalId: string, _options?: Configuration): Promise<GroupsResponseSchema>;
  /**
      ...
      */
  getIdentitySourceGroupMemberships(identitySourceId: string, groupOrExternalId: string, after?: string, limit?: number, _options?: Configuration): Promise<GroupMembershipsResponseSchema>;
  /**
      ...
      * @param sessionId The ID of the identity source session
      */
  getIdentitySourceSession(identitySourceId: string, sessionId: string, _options?: Configuration): Promise<IdentitySourceSession>;
  /**
      ...
      * @param externalId The external ID of the user
      */
  getIdentitySourceUser(identitySourceId: string, externalId: string, _options?: Configuration): Promise<UserResponseSchema>;
  /**
      * Lists all identity source sessions for the given identity source instance
      * List all identity source sessions
      * @param identitySourceId The ID of the identity source for which the session is created
      */
  listIdentitySourceSessions(identitySourceId: string, _options?: Configuration): Promise<Collection<IdentitySourceSession>>;
  /**
      ...
      * @param userRequestSchema
      */
  replaceExistingIdentitySourceUser(identitySourceId: string, externalId: string, userRequestSchema?: UserRequestSchema, _options?: Configuration): Promise<UserResponseSchema>;
  /**
      ...
      * @param sessionId The ID of the identity source session
      */
  startImportFromIdentitySource(identitySourceId: string, sessionId: string, _options?: Configuration): Promise<IdentitySourceSession>;
  /**
      ...
      * @param groupsRequestSchema
      */
  updateIdentitySourceGroups(identitySourceId: string, groupOrExternalId: string, groupsRequestSchema?: GroupsRequestSchema, _options?: Configuration): Promise<GroupsResponseSchema>;
  /**
      ...
      */
  updateIdentitySourceUsers(identitySourceId: string, externalId: string, usersUpdateRequestSchema?: UsersUpdateRequestSchema, _options?: Configuration): Promise<UserResponseSchema>;
  /**
      ...
      */
  uploadIdentitySourceDataForDelete(identitySourceId: string, sessionId: string, bulkDeleteRequestBody?: BulkDeleteRequestBody, _options?: Configuration): Promise<void>;
  /**
...
export declare class PromiseInlineHookApi {
  ...
  /**
      ...
      * @param inlineHook
      */
  createInlineHook(inlineHook: InlineHookCreate, _options?: Configuration): Promise<InlineHookCreateResponse>;
  /**
  ...
  /**
      ...
      * @param payloadData
      */
  executeInlineHook(inlineHookId: string, payloadData: ExecuteInlineHookRequest, _options?: Configuration): Promise<ExecuteInlineHook200Response>;
  /**
  ...
  /**
      ...
      */
  listInlineHooks(type?: 'com.okta.import.transform' | 'com.okta.oauth2.tokens.transform' | 'com.okta.saml.tokens.transform' | 'com.okta.user.credential.password.import' | 'com.okta.user.pre-registration' | 'com.okta.telephony.provider', _options?: Configuration): Promise<Collection<InlineHook>>;
  /**
      ...
      * @param inlineHook
      */
  replaceInlineHook(inlineHookId: string, inlineHook: InlineHookReplace, _options?: Configuration): Promise<InlineHook>;
  /**
      ...
      * @param inlineHook
      */
  updateInlineHook(inlineHookId: string, inlineHook: InlineHookReplace, _options?: Configuration): Promise<InlineHook>;
}
...
export declare class PromiseLinkedObjectApi {
  ...
  /**
      ...
      * @param linkedObject
      */
  createLinkedObjectDefinition(linkedObject: LinkedObject, _options?: Configuration): Promise<LinkedObject>;
  /**
...
export declare class PromiseLogStreamApi {
  private api;
  ...
  /**
      ...
      * @param logStreamId Unique identifier for the log stream
      */
  deleteLogStream(logStreamId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a log stream object by ID
      * Retrieve a log stream
      * @param logStreamId Unique identifier for the log stream
      */
  getLogStream(logStreamId: string, _options?: Configuration): Promise<LogStream>;
  /**
      ...
      */
  listLogStreams(after?: string, limit?: number, filter?: string, _options?: Configuration): Promise<Collection<LogStream>>;
  /**
      ...
      * @param instance
      */
  replaceLogStream(logStreamId: string, instance: LogStreamPutSchema, _options?: Configuration): Promise<LogStream>;
}
...
export declare class PromiseNetworkZoneApi {
  ...
  /**
      ...
      * @param zone
      */
  replaceNetworkZone(zoneId: string, zone: NetworkZone, _options?: Configuration): Promise<NetworkZone>;
}
...
export declare class PromiseOAuth2ResourceServerCredentialsKeysApi {
  private api;
  ...
  /**
      ...
      */
  activateOAuth2ResourceServerJsonWebKey(authServerId: string, keyId: string, _options?: Configuration): Promise<OAuth2ResourceServerJsonWebKey>;
  /**
      ...
      */
  addOAuth2ResourceServerJsonWebKey(authServerId: string, oAuth2ResourceServerJsonWebKeyRequestBody: OAuth2ResourceServerJsonWebKeyRequestBody, _options?: Configuration): Promise<OAuth2ResourceServerJsonWebKey>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the Custom Authorization Server JSON Web Key
      */
  deactivateOAuth2ResourceServerJsonWebKey(authServerId: string, keyId: string, _options?: Configuration): Promise<OAuth2ResourceServerJsonWebKey>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the Custom Authorization Server JSON Web Key
      */
  deleteOAuth2ResourceServerJsonWebKey(authServerId: string, keyId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the Custom Authorization Server JSON Web Key
      */
  getOAuth2ResourceServerJsonWebKey(authServerId: string, keyId: string, _options?: Configuration): Promise<OAuth2ResourceServerJsonWebKey>;
  /**
      ...
      * @param authServerId &#x60;id&#x60; of the Authorization Server
      */
  listOAuth2ResourceServerJsonWebKeys(authServerId: string, _options?: Configuration): Promise<Collection<OAuth2ResourceServerJsonWebKey>>;
}
...
export declare class PromiseOktaApplicationSettingsApi {
  private api;
  ...
  /**
      ...
      */
  getFirstPartyAppSettings(appName: string, _options?: Configuration): Promise<AdminConsoleSettings>;
  /**
      ...
      */
  replaceFirstPartyAppSettings(appName: string, adminConsoleSettings: AdminConsoleSettings, _options?: Configuration): Promise<AdminConsoleSettings>;
}
...
export declare class PromiseOktaManagedUserAccountApi {
  private api;
  ...
  /**
      ...
      * @param body
      */
  createOktaManagedUserAccount(body: OktaManagedUserAccountRequest, _options?: Configuration): Promise<OktaManagedUserAccount>;
  /**
      ...
      */
  deleteOktaManagedUserAccount(id: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves an Okta managed user account specified by ID
      * Retrieve an Okta managed user account
      * @param id ID of an existing Okta managed user account
      */
  getOktaManagedUserAccount(id: string, _options?: Configuration): Promise<OktaManagedUserAccount>;
  /**
      ...
      */
  listOktaManagedUserAccounts(limit?: number, after?: string, match?: string, _options?: Configuration): Promise<Collection<OktaManagedUserAccount>>;
  /**
      ...
      * @param body
      */
  updateOktaManagedUserAccount(id: string, body?: OktaManagedUserAccountForUpdate, _options?: Configuration): Promise<OktaManagedUserAccount>;
}
import { OktaPersonalSettingsApiRequestFactory, OktaPersonalSettingsApiResponseProcessor } from '../apis/OktaPersonalSettingsApi';
export declare class PromiseOktaPersonalSettingsApi {
  private api;
  ...
  /**
      ...
      */
  listPersonalAppsExportBlockList(_options?: Configuration): Promise<PersonalAppsBlockList>;
  /**
      ...
      */
  replaceBlockedEmailDomains(personalAppsBlockList: PersonalAppsBlockList, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  replaceOktaPersonalAdminSettings(oktaPersonalAdminFeatureSettings: OktaPersonalAdminFeatureSettings, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseOperationsIntegrationApi {
  private api;
  ...
  /**
      ...
      */
  getOperationStatus(operationId: string, _options?: Configuration): Promise<OperationResponse>;
}
import { OrgCreatorApiRequestFactory, OrgCreatorApiResponseProcessor } from '../apis/OrgCreatorApi';
export declare class PromiseOrgCreatorApi {
  private api;
  ...
  /**
      ...
      * @param childOrg
      */
  createChildOrg(childOrg?: ChildOrg, _options?: Configuration): Promise<ChildOrg>;
}
...
export declare class PromiseOrgSettingApi {
  ...
  /**
      ...
      */
  assignClientPrivilegesSetting(clientPrivilegesSetting?: ClientPrivilegesSetting, _options?: Configuration): Promise<ClientPrivilegesSetting>;
  /**
      ...
      */
  extendOktaSupport(_options?: Configuration): Promise<void>;
  /**
      ...
      */
  getAerialConsent(_options?: Configuration): Promise<OrgAerialConsentDetails>;
  /**
      ...
      */
  getAutoAssignAdminAppSetting(_options?: Configuration): Promise<AutoAssignAdminAppSetting>;
  /**
      ...
      */
  getClientPrivilegesSetting(_options?: Configuration): Promise<ClientPrivilegesSetting>;
  /**
  ...
  /**
      ...
      * @param contactType
      */
  getOrgContactUser(contactType: 'BILLING' | 'TECHNICAL', _options?: Configuration): Promise<OrgContactUser>;
  /**
  ...
  /**
      ...
      */
  getThirdPartyAdminSetting(_options?: Configuration): Promise<ThirdPartyAdminSetting>;
  /**
      ...
      */
  getWellknownOrgMetadata(_options?: Configuration): Promise<WellKnownOrgMetadata>;
  /**
      ...
      */
  grantAerialConsent(orgAerialConsent?: OrgAerialConsent, _options?: Configuration): Promise<OrgAerialConsentDetails>;
  /**
      ...
      */
  grantOktaSupport(_options?: Configuration): Promise<void>;
  /**
      * Lists all Okta Support cases that the requesting principal has permission to view
      * List all Okta Support cases
      */
  listOktaSupportCases(_options?: Configuration): Promise<OktaSupportCases>;
  /**
  ...
  /**
      ...
      */
  replaceOrgContactUser(contactType: 'BILLING' | 'TECHNICAL', orgContactUser: OrgContactUser, _options?: Configuration): Promise<OrgContactUser>;
  /**
      * Replaces the Org General Settings for your Okta org
      * Replace the Org general settings
      * @param orgSetting
      */
  replaceOrgSettings(orgSetting: OrgSetting, _options?: Configuration): Promise<OrgSetting>;
  /**
      ...
      * @param orgAerialConsent
      */
  revokeAerialConsent(orgAerialConsent?: OrgAerialConsent, _options?: Configuration): Promise<OrgAerialConsentRevoked>;
  /**
      ...
      */
  revokeOktaSupport(_options?: Configuration): Promise<void>;
  /**
      ...
      */
  updateAutoAssignAdminAppSetting(autoAssignAdminAppSetting?: AutoAssignAdminAppSetting, _options?: Configuration): Promise<AutoAssignAdminAppSetting>;
  /**
      ...
      */
  updateOktaSupportCase(caseNumber: string, oktaSupportCase?: OktaSupportCase, _options?: Configuration): Promise<OktaSupportCase>;
  /**
      ...
      */
  updateOrgHideOktaUIFooter(_options?: Configuration): Promise<OrgPreferences>;
  /**
      * Updates partial Org General Settings
      * Update the Org general settings
      * @param orgSetting
      */
  updateOrgSettings(orgSetting?: OrgSetting, _options?: Configuration): Promise<OrgSetting>;
  /**
      * Sets the preference to show the Okta UI footer for all end users of your org
      * Set the show dashboard footer preference
      */
  updateOrgShowOktaUIFooter(_options?: Configuration): Promise<OrgPreferences>;
  /**
      ...
      */
  updateThirdPartyAdminSetting(thirdPartyAdminSetting: ThirdPartyAdminSetting, _options?: Configuration): Promise<ThirdPartyAdminSetting>;
  /**
      ...
      */
  uploadOrgLogo(file: HttpFile, _options?: Configuration): Promise<void>;
}
...
export declare class PromisePolicyApi {
  ...
  /**
      ...
      */
  createPolicy(policy: CreateOrUpdatePolicy, activate?: boolean, _options?: Configuration): Promise<CreateOrUpdatePolicy>;
  /**
      ...
      */
  createPolicyRule(policyId: string, policyRule: PolicyRule, limit?: string, activate?: boolean, _options?: Configuration): Promise<PolicyRule>;
  /**
      ...
      */
  createPolicySimulation(simulatePolicy: Array<SimulatePolicyBody>, expand?: string, _options?: Configuration): Promise<SimulatePolicyResponse>;
  /**
  ...
  /**
      ...
      */
  deletePolicyResourceMapping(policyId: string, mappingId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param mappingId &#x60;id&#x60; of the policy resource Mapping
      */
  getPolicyMapping(policyId: string, mappingId: string, _options?: Configuration): Promise<PolicyMapping>;
  /**
  ...
  /**
      ...
      */
  listPolicies(type: 'OKTA_SIGN_ON' | 'PASSWORD' | 'MFA_ENROLL' | 'IDP_DISCOVERY' | 'ACCESS_POLICY' | 'DEVICE_SIGNAL_COLLECTION' | 'PROFILE_ENROLLMENT' | 'POST_AUTH_SESSION' | 'ENTITY_RISK', status?: string, q?: string, expand?: string, sortBy?: string, limit?: string, resourceId?: string, after?: string, _options?: Configuration): Promise<Collection<Policy>>;
  /**
      ...
      * @param policyId &#x60;id&#x60; of the Policy
      */
  listPolicyApps(policyId: string, _options?: Configuration): Promise<Collection<Application>>;
  /**
      * Lists all resources mapped to a policy identified by `policyId`
      * List all resources mapped to a policy
      * @param policyId &#x60;id&#x60; of the Policy
      */
  listPolicyMappings(policyId: string, _options?: Configuration): Promise<Collection<PolicyMapping>>;
  /**
      ...
      * @param limit Defines the number of policy rules returned. See [Pagination](https://developer.okta.com/docs/api/#pagination).
      */
  listPolicyRules(policyId: string, limit?: string, _options?: Configuration): Promise<Collection<PolicyRule>>;
  /**
      ...
      */
  mapResourceToPolicy(policyId: string, policyMappingRequest: PolicyMappingRequest, _options?: Configuration): Promise<PolicyMapping>;
  /**
      ...
      * @param policy
      */
  replacePolicy(policyId: string, policy: CreateOrUpdatePolicy, _options?: Configuration): Promise<Policy>;
  /**
      ...
      * @param policyRule
      */
  replacePolicyRule(policyId: string, ruleId: string, policyRule: PolicyRule, _options?: Configuration): Promise<PolicyRule>;
}
...
export declare class PromisePrincipalRateLimitApi {
  ...
  /**
      ...
      * @param entity
      */
  replacePrincipalRateLimitEntity(principalRateLimitId: string, entity: PrincipalRateLimitEntity, _options?: Configuration): Promise<PrincipalRateLimitEntity>;
}
import { PrivilegedResourceApiRequestFactory, PrivilegedResourceApiResponseProcessor } from '../apis/PrivilegedResourceApi';
export declare class PromisePrivilegedResourceApi {
  private api;
  ...
  /**
      ...
      */
  claimPrivilegedResource(id: string, _options?: Configuration): Promise<PrivilegedResource>;
  /**
      ...
      */
  createPrivilegedResource(privilegedResource: PrivilegedResource, _options?: Configuration): Promise<PrivilegedResource>;
  /**
      * Deletes a privileged resource specified by ID. This also marks the `status` as `INACTIVE`.
      * Delete a privileged resource
      * @param id ID of an existing privileged resource
      */
  deletePrivilegedResource(id: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a privileged resource specified by ID
      * Retrieve a privileged resource
      * @param id ID of an existing privileged resource
      */
  getPrivilegedResource(id: string, _options?: Configuration): Promise<PrivilegedResource>;
  /**
      ...
      */
  getPrivilegedResources(containerId: string, lastUpdated?: string, status?: string, limit?: number, after?: string, _options?: Configuration): Promise<Collection<PrivilegedResourceAccountAppResponse>>;
  /**
      ...
      * @param lastUpdated Last updated timestamp query parameter
      */
  preparePrivilegedResourcesToBeFetched(containerId: string, lastUpdated?: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  replaceFiltersForPrivilegedResourceIdentification(containerId: string, privilegedResourceFilters: PrivilegedResourceFilters, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  replacePrivilegedResource(id: string, privilegedResourceUpdateRequest: PrivilegedResourceUpdateRequest, _options?: Configuration): Promise<PrivilegedResource>;
  /**
      ...
      */
  rotatePasswordForPrivilegedResource(id: string, rotatePasswordRequest: RotatePasswordRequest, _options?: Configuration): Promise<PrivilegedResource>;
}
...
export declare class PromiseProfileMappingApi {
  ...
  /**
      ...
      */
  listProfileMappings(after?: string, limit?: number, sourceId?: string, targetId?: string, _options?: Configuration): Promise<Collection<ListProfileMappings>>;
  /**
      ...
      */
  updateProfileMapping(mappingId: string, profileMapping: ProfileMappingRequest, _options?: Configuration): Promise<ProfileMapping>;
}
import { PushProviderApiRequestFactory, PushProviderApiResponseProcessor } from '../apis/PushProviderApi';
export declare class PromisePushProviderApi {
  private api;
  ...
  /**
      ...
      * @param pushProvider
      */
  createPushProvider(pushProvider: PushProvider, _options?: Configuration): Promise<PushProvider>;
  /**
      ...
      */
  deletePushProvider(pushProviderId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a push provider by `pushProviderId`
      * Retrieve a push provider
      * @param pushProviderId Id of the push provider
      */
  getPushProvider(pushProviderId: string, _options?: Configuration): Promise<PushProvider>;
  /**
      * Lists all push providers
      * List all push providers
      * @param type Filters push providers by &#x60;providerType&#x60;
      */
  listPushProviders(type?: ProviderType, _options?: Configuration): Promise<Collection<PushProvider>>;
  /**
      ...
      * @param pushProvider
      */
  replacePushProvider(pushProviderId: string, pushProvider: PushProvider, _options?: Configuration): Promise<PushProvider>;
}
import { RateLimitSettingsApiRequestFactory, RateLimitSettingsApiResponseProcessor } from '../apis/RateLimitSettingsApi';
export declare class PromiseRateLimitSettingsApi {
  private api;
  ...
  /**
      ...
      */
  getRateLimitSettingsAdminNotifications(_options?: Configuration): Promise<RateLimitAdminNotifications>;
  /**
      * Retrieves the currently configured Per-Client Rate Limit Settings
      * Retrieve the per-client rate limit settings
      */
  getRateLimitSettingsPerClient(_options?: Configuration): Promise<PerClientRateLimitSettings>;
  /**
      ...
      */
  getRateLimitSettingsWarningThreshold(_options?: Configuration): Promise<RateLimitWarningThresholdResponse>;
  /**
      * Replaces the Rate Limit Admin Notification Settings and returns the configured properties
      * Replace the rate limit admin notification settings
      * @param rateLimitAdminNotifications
      */
  replaceRateLimitSettingsAdminNotifications(rateLimitAdminNotifications: RateLimitAdminNotifications, _options?: Configuration): Promise<RateLimitAdminNotifications>;
  /**
      * Replaces the Per-Client Rate Limit Settings and returns the configured properties
      * Replace the per-client rate limit settings
      * @param perClientRateLimitSettings
      */
  replaceRateLimitSettingsPerClient(perClientRateLimitSettings: PerClientRateLimitSettings, _options?: Configuration): Promise<PerClientRateLimitSettings>;
  /**
      ...
      */
  replaceRateLimitSettingsWarningThreshold(rateLimitWarningThreshold?: RateLimitWarningThresholdRequest, _options?: Configuration): Promise<RateLimitWarningThresholdResponse>;
}
import { RealmApiRequestFactory, RealmApiResponseProcessor } from '../apis/RealmApi';
export declare class PromiseRealmApi {
  private api;
  ...
  /**
      ...
      * @param body
      */
  createRealm(body: CreateRealmRequest, _options?: Configuration): Promise<Realm>;
  /**
      ...
      */
  deleteRealm(realmId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a realm
      * Retrieve a realm
      * @param realmId ID of the realm
      */
  getRealm(realmId: string, _options?: Configuration): Promise<Realm>;
  /**
      ...
      * @param sortOrder Specifies sort order: &#x60;asc&#x60; or &#x60;desc&#x60; (for search queries only). This parameter is ignored if &#x60;sortBy&#x60; isn\&#39;t present.
      */
  listRealms(limit?: number, after?: string, search?: string, sortBy?: string, sortOrder?: string, _options?: Configuration): Promise<Collection<Realm>>;
  /**
      ...
      * @param body
      */
  replaceRealm(realmId: string, body: UpdateRealmRequest, _options?: Configuration): Promise<Realm>;
}
import { RealmAssignmentApiRequestFactory, RealmAssignmentApiResponseProcessor } from '../apis/RealmAssignmentApi';
export declare class PromiseRealmAssignmentApi {
  private api;
  ...
  /**
      ...
      */
  activateRealmAssignment(assignmentId: string, _options?: Configuration): Promise<void>;
  /**
      * Creates a new realm assignment
      * Create a realm assignment
      * @param body
      */
  createRealmAssignment(body: CreateRealmAssignmentRequest, _options?: Configuration): Promise<RealmAssignment>;
  /**
      * Deactivates a realm assignment
      * Deactivate a realm assignment
      * @param assignmentId ID of the realm assignment
      */
  deactivateRealmAssignment(assignmentId: string, _options?: Configuration): Promise<void>;
  /**
      * Deletes a realm assignment
      * Delete a realm assignment
      * @param assignmentId ID of the realm assignment
      */
  deleteRealmAssignment(assignmentId: string, _options?: Configuration): Promise<void>;
  /**
      * Executes a realm assignment
      * Execute a realm assignment
      * @param body
      */
  executeRealmAssignment(body: OperationRequest, _options?: Configuration): Promise<RealmAssignmentOperationResponse>;
  /**
      * Retrieves a realm assignment
      * Retrieve a realm assignment
      * @param assignmentId ID of the realm assignment
      */
  getRealmAssignment(assignmentId: string, _options?: Configuration): Promise<RealmAssignment>;
  /**
      ...
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listRealmAssignmentOperations(limit?: number, after?: string, _options?: Configuration): Promise<Collection<RealmAssignmentOperationResponse>>;
  /**
      ...
      */
  listRealmAssignments(limit?: number, after?: string, _options?: Configuration): Promise<Collection<RealmAssignment>>;
  /**
      ...
      * @param body
      */
  replaceRealmAssignment(assignmentId: string, body: UpdateRealmAssignmentRequest, _options?: Configuration): Promise<RealmAssignment>;
}
import { ResourceSetApiRequestFactory, ResourceSetApiResponseProcessor } from '../apis/ResourceSetApi';
export declare class PromiseResourceSetApi {
  private api;
  ...
  /**
      ...
      * @param instance
      */
  addMembersToBinding(resourceSetId: string, roleIdOrLabel: string, instance: ResourceSetBindingAddMembersRequest, _options?: Configuration): Promise<ResourceSetBindingEditResponse>;
  /**
      ...
      * @param instance
      */
  addResourceSetResource(resourceSetId: string, instance: ResourceSetResourcePostRequest, _options?: Configuration): Promise<ResourceSetResource>;
  /**
      ...
      * @param instance
      */
  addResourceSetResources(resourceSetId: string, instance: ResourceSetResourcePatchRequest, _options?: Configuration): Promise<ResourceSet>;
  /**
      ...
      * @param instance
      */
  createResourceSet(instance: CreateResourceSetRequest, _options?: Configuration): Promise<ResourceSet>;
  /**
      ...
      * @param instance
      */
  createResourceSetBinding(resourceSetId: string, instance: ResourceSetBindingCreateRequest, _options?: Configuration): Promise<ResourceSetBindingEditResponse>;
  /**
      ...
      * @param roleIdOrLabel &#x60;id&#x60; or &#x60;label&#x60; of the role
      */
  deleteBinding(resourceSetId: string, roleIdOrLabel: string, _options?: Configuration): Promise<void>;
  /**
      * Deletes a resource set by `resourceSetIdOrLabel`
      * Delete a resource set
      * @param resourceSetId &#x60;id&#x60; or &#x60;label&#x60; of the resource set
      */
  deleteResourceSet(resourceSetId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  deleteResourceSetResource(resourceSetId: string, resourceId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param roleIdOrLabel &#x60;id&#x60; or &#x60;label&#x60; of the role
      */
  getBinding(resourceSetId: string, roleIdOrLabel: string, _options?: Configuration): Promise<ResourceSetBindingResponse>;
  /**
      ...
      */
  getMemberOfBinding(resourceSetId: string, roleIdOrLabel: string, memberId: string, _options?: Configuration): Promise<ResourceSetBindingMember>;
  /**
      * Retrieves a resource set by `resourceSetIdOrLabel`
      * Retrieve a resource set
      * @param resourceSetId &#x60;id&#x60; or &#x60;label&#x60; of the resource set
      */
  getResourceSet(resourceSetId: string, _options?: Configuration): Promise<ResourceSet>;
  /**
      ...
      * @param resourceId &#x60;id&#x60; of the resource
      */
  getResourceSetResource(resourceSetId: string, resourceId: string, _options?: Configuration): Promise<ResourceSetResource>;
  /**
      ...
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listBindings(resourceSetId: string, after?: string, _options?: Configuration): Promise<ResourceSetBindings>;
  /**
      ...
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listMembersOfBinding(resourceSetId: string, roleIdOrLabel: string, after?: string, _options?: Configuration): Promise<ResourceSetBindingMembers>;
  /**
      ...
      */
  listResourceSetResources(resourceSetId: string, after?: string, limit?: number, _options?: Configuration): Promise<ResourceSetResources>;
  /**
      * Lists all resource sets with pagination support
      * List all resource sets
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination) and [Link header](https://developer.okta.com/docs/api/#link-header).
      */
  listResourceSets(after?: string, _options?: Configuration): Promise<ResourceSets>;
  /**
      ...
      * @param instance
      */
  replaceResourceSet(resourceSetId: string, instance: ResourceSet, _options?: Configuration): Promise<ResourceSet>;
  /**
      ...
      */
  replaceResourceSetResource(resourceSetId: string, resourceId: string, resourceSetResourcePutRequest: ResourceSetResourcePutRequest, _options?: Configuration): Promise<ResourceSetResource>;
  /**
      ...
      * @param memberId &#x60;id&#x60; of the member
      */
  unassignMemberFromBinding(resourceSetId: string, roleIdOrLabel: string, memberId: string, _options?: Configuration): Promise<void>;
}
import { RiskEventApiRequestFactory, RiskEventApiResponseProcessor } from '../apis/RiskEventApi';
export declare class PromiseRiskEventApi {
  private api;
  ...
  /**
      ...
      * @param instance
      */
  sendRiskEvents(instance: Array<RiskEvent>, _options?: Configuration): Promise<void>;
}
import { RiskProviderApiRequestFactory, RiskProviderApiResponseProcessor } from '../apis/RiskProviderApi';
export declare class PromiseRiskProviderApi {
  private api;
  ...
  /**
      ...
      * @param instance
      */
  createRiskProvider(instance: RiskProvider, _options?: Configuration): Promise<RiskProvider>;
  /**
      * Deletes a risk provider object by its ID
      * Delete a risk provider
      * @param riskProviderId &#x60;id&#x60; of the risk provider object
      */
  deleteRiskProvider(riskProviderId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a risk provider object by ID
      * Retrieve a risk provider
      * @param riskProviderId &#x60;id&#x60; of the risk provider object
      */
  getRiskProvider(riskProviderId: string, _options?: Configuration): Promise<RiskProvider>;
  /**
      * Lists all risk provider objects
      * List all risk providers
      */
  listRiskProviders(_options?: Configuration): Promise<Collection<RiskProvider>>;
  /**
      ...
      * @param instance
      */
  replaceRiskProvider(riskProviderId: string, instance: RiskProvider, _options?: Configuration): Promise<RiskProvider>;
}
import { RoleAssignmentApiRequestFactory, RoleAssignmentApiResponseProcessor } from '../apis/RoleAssignmentApi';
export declare class PromiseRoleAssignmentApi {
  private api;
  ...
  /**
      ...
      */
  assignRoleToClient(clientId: string, assignRoleRequest: AssignRoleToClientRequest, _options?: Configuration): Promise<ListRolesForClient200ResponseInner>;
  /**
      ...
      */
  assignRoleToGroup(groupId: string, assignRoleRequest: AssignRoleToGroupRequest, disableNotifications?: boolean, _options?: Configuration): Promise<void | AssignRoleToGroup200Response>;
  /**
      ...
      */
  assignRoleToUser(userId: string, assignRoleRequest: AssignRoleToUserRequest, disableNotifications?: boolean, _options?: Configuration): Promise<AssignRoleToUser201Response>;
  /**
      ...
      */
  deleteRoleFromClient(clientId: string, roleAssignmentId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  getGroupAssignedRole(groupId: string, roleId: string, _options?: Configuration): Promise<AssignRoleToGroup200Response>;
  /**
      ...
      * @param grantId Grant ID
      */
  getRoleAssignmentGovernanceGrant(userId: string, roleAssignmentId: string, grantId: string, _options?: Configuration): Promise<RoleGovernanceSource>;
  /**
      ...
      * @param grantId Grant ID
      */
  getRoleAssignmentGovernanceGrantResources(userId: string, roleAssignmentId: string, grantId: string, _options?: Configuration): Promise<RoleGovernanceResources>;
  /**
      ...
      * @param roleId The &#x60;id&#x60; of the role assignment
      */
  getUserAssignedRole(userId: string, roleId: string, _options?: Configuration): Promise<AssignRoleToGroup200Response>;
  /**
      ...
      * @param roleAssignmentId The &#x60;id&#x60; of the role assignment
      */
  getUserAssignedRoleGovernance(userId: string, roleAssignmentId: string, _options?: Configuration): Promise<RoleGovernance>;
  /**
      ...
      */
  listAssignedRolesForUser(userId: string, expand?: string, _options?: Configuration): Promise<Collection<ListGroupAssignedRoles200ResponseInner>>;
  /**
      ...
      * @param expand An optional parameter used to return targets configured for the standard role assignment in the &#x60;embedded&#x60; property. Supported values: &#x60;targets/groups&#x60; or &#x60;targets/catalog/apps&#x60;
      */
  listGroupAssignedRoles(groupId: string, expand?: string, _options?: Configuration): Promise<Collection<ListGroupAssignedRoles200ResponseInner>>;
  /**
      * Lists all roles assigned to a client app identified by `clientId`
      * List all client role assignments
      * @param clientId &#x60;client_id&#x60; of the app
      */
  listRolesForClient(clientId: string, _options?: Configuration): Promise<Collection<ListRolesForClient200ResponseInner>>;
  /**
      ...
      * @param limit Specifies the number of results returned. Defaults to &#x60;100&#x60;.
      */
  listUsersWithRoleAssignments(after?: string, limit?: number, _options?: Configuration): Promise<RoleAssignedUsers>;
  /**
      ...
      * @param roleAssignmentId The &#x60;id&#x60; of the role assignment
      */
  retrieveClientRole(clientId: string, roleAssignmentId: string, _options?: Configuration): Promise<ListRolesForClient200ResponseInner>;
  /**
      ...
      * @param roleId The &#x60;id&#x60; of the role assignment
      */
  unassignRoleFromGroup(groupId: string, roleId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param roleId The &#x60;id&#x60; of the role assignment
      */
  unassignRoleFromUser(userId: string, roleId: string, _options?: Configuration): Promise<void>;
}
import { RoleTargetApiRequestFactory, RoleTargetApiResponseProcessor } from '../apis/RoleTargetApi';
export declare class PromiseRoleTargetApi {
  private api;
  ...
  /**
      ...
      * @param roleId The &#x60;id&#x60; of the role assignment
      */
  assignAllAppsAsTargetToRoleForUser(userId: string, roleId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  assignAppInstanceTargetToAppAdminRoleForGroup(groupId: string, roleId: string, appName: string, applicationId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param applicationId Application ID
      */
  assignAppInstanceTargetToAppAdminRoleForUser(userId: string, roleId: string, appName: string, applicationId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appId Application ID
      */
  assignAppTargetInstanceRoleForClient(clientId: string, roleAssignmentId: string, appName: string, appId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  assignAppTargetRoleToClient(clientId: string, roleAssignmentId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  assignAppTargetToAdminRoleForGroup(groupId: string, roleId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  assignAppTargetToAdminRoleForUser(userId: string, roleId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupId The &#x60;id&#x60; of the group
      */
  assignGroupTargetRoleForClient(clientId: string, roleAssignmentId: string, groupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param targetGroupId
      */
  assignGroupTargetToGroupAdminRole(groupId: string, roleId: string, targetGroupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupId The &#x60;id&#x60; of the group
      */
  assignGroupTargetToUserRole(userId: string, roleId: string, groupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  getRoleTargetsByUserIdAndRoleId(userId: string, roleIdOrEncodedRoleId: string, assignmentType?: 'USER' | 'GROUP', after?: string, limit?: number, _options?: Configuration): Promise<Collection<RoleTarget>>;
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listAppTargetRoleToClient(clientId: string, roleAssignmentId: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<CatalogApplication>>;
  /**
  ...
  /**
      ...
      * @param limit A limit on the number of objects to return
      */
  listGroupTargetRoleForClient(clientId: string, roleAssignmentId: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<Group>>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  removeAppTargetInstanceRoleForClient(clientId: string, roleAssignmentId: string, appName: string, appId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  removeAppTargetRoleFromClient(clientId: string, roleAssignmentId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupId The &#x60;id&#x60; of the group
      */
  removeGroupTargetRoleFromClient(clientId: string, roleAssignmentId: string, groupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param applicationId Application ID
      */
  unassignAppInstanceTargetFromAdminRoleForUser(userId: string, roleId: string, appName: string, applicationId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param applicationId Application ID
      */
  unassignAppInstanceTargetToAppAdminRoleForGroup(groupId: string, roleId: string, appName: string, applicationId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  unassignAppTargetFromAppAdminRoleForUser(userId: string, roleId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  unassignAppTargetToAdminRoleForGroup(groupId: string, roleId: string, appName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param targetGroupId
      */
  unassignGroupTargetFromGroupAdminRole(groupId: string, roleId: string, targetGroupId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param groupId The &#x60;id&#x60; of the group
      */
  unassignGroupTargetFromUserAdminRole(userId: string, roleId: string, groupId: string, _options?: Configuration): Promise<void>;
}
import { SSFReceiverApiRequestFactory, SSFReceiverApiResponseProcessor } from '../apis/SSFReceiverApi';
export declare class PromiseSSFReceiverApi {
  private api;
  ...
  /**
      ...
      */
  activateSecurityEventsProviderInstance(securityEventProviderId: string, _options?: Configuration): Promise<SecurityEventsProviderResponse>;
  /**
      * Creates a Security Events Provider instance
      * Create a security events provider
      * @param instance
      */
  createSecurityEventsProviderInstance(instance: SecurityEventsProviderRequest, _options?: Configuration): Promise<SecurityEventsProviderResponse>;
  /**
      ...
      * @param securityEventProviderId &#x60;id&#x60; of the Security Events Provider instance
      */
  deactivateSecurityEventsProviderInstance(securityEventProviderId: string, _options?: Configuration): Promise<SecurityEventsProviderResponse>;
  /**
      * Deletes a Security Events Provider instance specified by `id`
      * Delete a security events provider
      * @param securityEventProviderId &#x60;id&#x60; of the Security Events Provider instance
      */
  deleteSecurityEventsProviderInstance(securityEventProviderId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves the Security Events Provider instance specified by `id`
      * Retrieve the security events provider
      * @param securityEventProviderId &#x60;id&#x60; of the Security Events Provider instance
      */
  getSecurityEventsProviderInstance(securityEventProviderId: string, _options?: Configuration): Promise<SecurityEventsProviderResponse>;
  /**
      * Lists all Security Events Provider instances
      * List all security events providers
      */
  listSecurityEventsProviderInstances(_options?: Configuration): Promise<Collection<SecurityEventsProviderResponse>>;
  /**
      ...
      * @param instance
      */
  replaceSecurityEventsProviderInstance(securityEventProviderId: string, instance: SecurityEventsProviderRequest, _options?: Configuration): Promise<SecurityEventsProviderResponse>;
}
...
export declare class PromiseSSFSecurityEventTokenApi {
  private api;
  ...
  /**
      ...
      */
  publishSecurityEventTokens(securityEventToken: string, _options?: Configuration): Promise<void>;
}
import { SSFTransmitterApiRequestFactory, SSFTransmitterApiResponseProcessor } from '../apis/SSFTransmitterApi';
export declare class PromiseSSFTransmitterApi {
  private api;
  ...
  /**
      ...
      * @param instance
      */
  createSsfStream(instance: StreamConfigurationCreateRequest, _options?: Configuration): Promise<StreamConfiguration>;
  /**
      ...
      */
  deleteSsfStream(streamId?: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param streamId The ID of the specified SSF Stream configuration
      */
  getSsfStreamStatus(streamId: string, _options?: Configuration): Promise<StreamStatus>;
  /**
      ...
      * @param streamId The ID of the specified SSF Stream configuration
      */
  getSsfStreams(streamId?: string, _options?: Configuration): Promise<GetSsfStreams200Response>;
  /**
      ...
      */
  getWellknownSsfMetadata(_options?: Configuration): Promise<WellKnownSSFMetadata>;
  /**
      ...
      * @param instance
      */
  replaceSsfStream(instance: StreamConfiguration, _options?: Configuration): Promise<StreamConfiguration>;
  /**
      ...
      * @param instance
      */
  updateSsfStream(instance: StreamConfiguration, _options?: Configuration): Promise<StreamConfiguration>;
  /**
      ...
      * @param instance
      */
  verifySsfStream(instance: StreamVerificationRequest, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseSchemaApi {
  ...
  /**
      ...
      * @param logStreamType
      */
  getLogStreamSchema(logStreamType: LogStreamType, _options?: Configuration): Promise<LogStreamSchema>;
  /**
  ...
  /**
      ...
      */
  listLogStreamSchemas(_options?: Configuration): Promise<Collection<LogStreamSchema>>;
  /**
...
export declare class PromiseServiceAccountApi {
  private api;
  ...
  /**
      ...
      * @param body
      */
  createAppServiceAccount(body: AppServiceAccount, _options?: Configuration): Promise<AppServiceAccount>;
  /**
      * Creates a new service account for managing an Okta User or SaaS app account
      * Create a service account
      * @param body
      */
  createServiceAccount(body: ServiceAccount, _options?: Configuration): Promise<ServiceAccount>;
  /**
      * Deletes an app service account specified by ID
      * Delete an app service account
      * @param id ID of an existing service account
      */
  deleteAppServiceAccount(id: string, _options?: Configuration): Promise<void>;
  /**
      * Deletes a service account specified by ID
      * Delete a service account
      * @param id ID of an existing service account
      */
  deleteServiceAccount(id: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves an app service account specified by ID
      * Retrieve an app service account
      * @param id ID of an existing service account
      */
  getAppServiceAccount(id: string, _options?: Configuration): Promise<AppServiceAccount>;
  /**
      * Retrieves a service account specified by ID
      * Retrieve a service account
      * @param id ID of an existing service account
      */
  getServiceAccount(id: string, _options?: Configuration): Promise<ServiceAccount>;
  /**
      ...
      */
  listAppServiceAccounts(limit?: number, after?: string, match?: string, _options?: Configuration): Promise<Collection<AppServiceAccount>>;
  /**
      ...
      */
  listServiceAccounts(limit?: number, after?: string, q?: string, _options?: Configuration): Promise<Collection<ServiceAccount>>;
  /**
      ...
      * @param body
      */
  updateAppServiceAccount(id: string, body?: AppServiceAccountForUpdate, _options?: Configuration): Promise<AppServiceAccount>;
  /**
      ...
      * @param body
      */
  updateServiceAccount(id: string, body?: ServiceAccountForUpdate, _options?: Configuration): Promise<ServiceAccount>;
}
...
export declare class PromiseSessionApi {
  ...
  /**
      ...
      * @param cookie
      */
  closeCurrentSession(cookie?: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param cookie
      */
  getCurrentSession(cookie?: string, _options?: Configuration): Promise<Session>;
  /**
  ...
  /**
      ...
      * @param cookie
      */
  refreshCurrentSession(cookie?: string, _options?: Configuration): Promise<Session>;
  /**
  ...
  /**
      ...
      * @param sessionId &#x60;id&#x60; of the session
      */
  revokeSession(sessionId: string, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseSubscriptionApi {
  ...
  /**
      ...
      */
  listRoleSubscriptions(roleTypeOrRoleId: ListRoleSubscriptionsRoleTypeOrRoleIdParameter, _options?: Configuration): Promise<Collection<Subscription>>;
  /**
      ...
      */
  listRoleSubscriptionsByNotificationType(roleTypeOrRoleId: ListRoleSubscriptionsRoleTypeOrRoleIdParameter, notificationType: NotificationType, _options?: Configuration): Promise<Subscription>;
  /**
  ...
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  listUserSubscriptionsByNotificationType(notificationType: NotificationType, userId: string, _options?: Configuration): Promise<Subscription>;
  /**
      ...
      * @param notificationType
      */
  subscribeRoleSubscriptionByNotificationType(roleTypeOrRoleId: ListRoleSubscriptionsRoleTypeOrRoleIdParameter, notificationType: NotificationType, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  subscribeUserSubscriptionByNotificationType(notificationType: NotificationType, userId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param notificationType
      */
  unsubscribeRoleSubscriptionByNotificationType(roleTypeOrRoleId: ListRoleSubscriptionsRoleTypeOrRoleIdParameter, notificationType: NotificationType, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  unsubscribeUserSubscriptionByNotificationType(notificationType: NotificationType, userId: string, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseSystemLogApi {
  ...
  /**
      ...
      */
  listLogEvents(since?: string, until?: string, after?: string, filter?: string, q?: string, limit?: number, sortOrder?: 'ASCENDING' | 'DESCENDING', _options?: Configuration): Promise<Collection<LogEvent>>;
}
...
export declare class PromiseTemplateApi {
  ...
  /**
      ...
      * @param smsTemplate
      */
  replaceSmsTemplate(templateId: string, smsTemplate: SmsTemplate, _options?: Configuration): Promise<SmsTemplate>;
  /**
...
export declare class PromiseTrustedOriginApi {
  ...
  /**
      ...
      */
  activateTrustedOrigin(trustedOriginId: string, _options?: Configuration): Promise<TrustedOrigin>;
  /**
      * Creates a trusted origin
      * Create a trusted origin
      * @param trustedOrigin
      */
  createTrustedOrigin(trustedOrigin: TrustedOriginWrite, _options?: Configuration): Promise<TrustedOrigin>;
  /**
      * Deactivates a trusted origin. Sets the `status` to `INACTIVE`.
      * Deactivate a trusted origin
      * @param trustedOriginId &#x60;id&#x60; of the trusted origin
      */
  deactivateTrustedOrigin(trustedOriginId: string, _options?: Configuration): Promise<TrustedOrigin>;
  /**
      * Deletes a trusted origin
      * Delete a trusted origin
      * @param trustedOriginId &#x60;id&#x60; of the trusted origin
      */
  deleteTrustedOrigin(trustedOriginId: string, _options?: Configuration): Promise<void>;
  /**
      * Retrieves a trusted origin
      * Retrieve a trusted origin
      * @param trustedOriginId &#x60;id&#x60; of the trusted origin
      */
  getTrustedOrigin(trustedOriginId: string, _options?: Configuration): Promise<TrustedOrigin>;
  /**
      ...
      */
  listTrustedOrigins(q?: string, filter?: string, after?: string, limit?: number, _options?: Configuration): Promise<Collection<TrustedOrigin>>;
  /**
      ...
      * @param trustedOrigin
      */
  replaceTrustedOrigin(trustedOriginId: string, trustedOrigin: TrustedOrigin, _options?: Configuration): Promise<TrustedOrigin>;
}
import { UISchemaApiRequestFactory, UISchemaApiResponseProcessor } from '../apis/UISchemaApi';
export declare class PromiseUISchemaApi {
  private api;
  ...
  /**
      ...
      * @param uischemabody
      */
  createUISchema(uischemabody: CreateUISchema, _options?: Configuration): Promise<UISchemasResponseObject>;
  /**
      * Deletes a UI Schema by `id`
      * Delete a UI schema
      * @param id The unique ID of the UI Schema
      */
  deleteUISchemas(id: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param operation
      */
  getAppUISchema(appName: string, section: string, operation: string, _options?: Configuration): Promise<ApplicationLayout>;
  /**
      * Retrieves the links for UI schemas for an application given `appName`
      * Retrieve the links for UI schemas for an application
      * @param appName Name of the app definition (the OIN catalog app key name)
      */
  getAppUISchemaLinks(appName: string, _options?: Configuration): Promise<ApplicationLayouts>;
  /**
      * Retrieves a UI Schema by `id`
      * Retrieve a UI schema
      * @param id The unique ID of the UI Schema
      */
  getUISchema(id: string, _options?: Configuration): Promise<UISchemasResponseObject>;
  /**
      * Lists all UI Schemas in your org
      * List all UI schemas
      */
  listUISchemas(_options?: Configuration): Promise<Collection<UISchemasResponseObject>>;
  /**
      ...
      */
  replaceUISchemas(id: string, updateUISchemaBody: UpdateUISchema, _options?: Configuration): Promise<UISchemasResponseObject>;
}
import { UnconfirmedUsersApiRequestFactory, UnconfirmedUsersApiResponseProcessor } from '../apis/UnconfirmedUsersApi';
export declare class PromiseUnconfirmedUsersApi {
  private api;
  ...
  /**
      ...
      * @param limit Specifies the number of objects to return per page. If there are multiple pages of results, the Link header contains a &#x60;next&#x60; link that you need to use as an opaque value (follow it, don\&#39;t parse it). See [Pagination](/#pagination).
      */
  listUnconfirmedUsers(appId: string, after?: string, limit?: number, _options?: Configuration): Promise<UnconfirmedUserResponseSchema>;
}
...
export declare class PromiseUserApi {
  ...
  /**
      ...
      */
  deactivateUser(userId: string, sendEmail?: boolean, prefer?: 'respond-async', _options?: Configuration): Promise<void>;
  /**
      ...
      */
  deleteLinkedObjectForUser(userId: string, relationshipName: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param prefer
      */
  deleteUser(userId: string, sendEmail?: boolean, prefer?: 'respond-async', _options?: Configuration): Promise<void>;
  /**
      ...
      * @param keepCurrent
      */
  endUserSessions(keepCurrent?: KeepCurrent, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param expand Valid value: &#x60;scope&#x60;. If specified, scope details are included in the &#x60;_embedded&#x60; attribute.
      */
  getRefreshTokenForUserAndClient(userId: string, clientId: string, tokenId: string, expand?: string, _options?: Configuration): Promise<OAuth2RefreshToken>;
  /**
      ...
      */
  getUser(userId: string, contentType?: string, expand?: string, _options?: Configuration): Promise<UserGetSingleton>;
  /**
      * Retrieves a user\'s classification
      * Retrieve a user\'s classification
      * @param userId ID of an existing Okta user
      */
  getUserClassification(userId: string, _options?: Configuration): Promise<UserClassification>;
  /**
  ...
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  getUserRisk(userId: string, _options?: Configuration): Promise<UserRiskGetResponse>;
  /**
      * Links an Okta user to an existing SAML or social identity provider (IdP).  The SAML IdP must have `honorPersistentNameId` set to `true` to use this API. The [Name Identifier Format](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/IdentityProvider/#tag/IdentityProvider/operation/replaceIdentityProvider!path=protocol/0/settings&t=request) of the incoming assertion must be `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent`.
      * Link a user to IdP
      * @param idpId &#x60;id&#x60; of IdP
  ...
  /**
      ...
      * @param userId An ID, login, or login shortname (as long as the shortname is unambiguous) of an existing Okta user
      */
  listAppLinks(userId: string, _options?: Configuration): Promise<Collection<AssignedAppLink>>;
  /**
  ...
  /**
      ...
      * @param relationshipName Name of the &#x60;primary&#x60; or &#x60;associated&#x60; relationship being queried
      */
  listLinkedObjectsForUser(userId: string, relationshipName: string, _options?: Configuration): Promise<Collection<ResponseLinks>>;
  /**
  ...
  /**
      ...
      * @param userId An ID, login, or login shortname (as long as the shortname is unambiguous) of an existing Okta user
      */
  listUserBlocks(userId: string, _options?: Configuration): Promise<Collection<UserBlock>>;
  /**
  ...
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  listUserDevices(userId: string, _options?: Configuration): Promise<Collection<UserDevice>>;
  /**
  ...
  /**
      ...
      */
  listUsers(contentType?: string, search?: string, filter?: string, q?: string, after?: string, limit?: number, sortBy?: string, sortOrder?: string, fields?: string, expand?: string, _options?: Configuration): Promise<Collection<User>>;
  /**
  ...
  /**
      ...
      */
  replaceUser(userId: string, user: UpdateUserRequest, strict?: boolean, ifMatch?: string, _options?: Configuration): Promise<User>;
  /**
      ...
      */
  replaceUserClassification(userId: string, replaceUserClassification: ReplaceUserClassification, _options?: Configuration): Promise<UserClassification>;
  /**
  ...
  /**
      ...
      */
  revokeUserSessions(userId: string, oauthTokens?: boolean, forgetDevices?: boolean, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param ifMatch The ETag value of the user\&#39;s expected current state. This becomes a conditional request used for concurrency control. See [Conditional Requests and Entity Tags](/#conditional-requests-and-entity-tags).
      */
  updateUser(userId: string, user: UpdateUserRequest, strict?: boolean, ifMatch?: string, _options?: Configuration): Promise<User>;
  /**
...
export declare class PromiseUserAuthenticatorEnrollmentsApi {
  ...
  /**
      ...
      */
  getAuthenticatorEnrollment(userId: string, enrollmentId: string, discloseIdentifiers?: Array<'phone'>, _options?: Configuration): Promise<AuthenticatorEnrollment>;
  /**
      ...
      * @param discloseIdentifiers Indicates whether or not the identifier of an authenticator enrollment is disclosed or anonymized. If it\&#39;s included in the operation query, then the identifier of the authenticator enrollment (the actual phone number, for example) is included in the response.
      */
  listAuthenticatorEnrollments(userId: string, discloseIdentifiers?: Array<'phone'>, _options?: Configuration): Promise<AuthenticatorEnrollment>;
}
...
export declare class PromiseUserFactorApi {
  ...
  /**
      ...
      * @param body
      */
  activateFactor(userId: string, factorId: string, body?: UserFactorActivateRequest, _options?: Configuration): Promise<UserFactorActivateResponse>;
  /**
      ...
      */
  enrollFactor(userId: string, body: UserFactor, updatePhone?: boolean, templateId?: string, tokenLifetimeSeconds?: number, activate?: boolean, acceptLanguage?: string, _options?: Configuration): Promise<UserFactor>;
  /**
  ...
  /**
      ...
      */
  getFactorTransactionStatus(userId: string, factorId: string, transactionId: string, _options?: Configuration): Promise<UserFactorPushTransaction>;
  /**
      * Retrieves the specified YubiKey OTP token by `id`
      * Retrieve a YubiKey OTP token
      * @param tokenId ID of a YubiKey token
      */
  getYubikeyOtpTokenById(tokenId: string, _options?: Configuration): Promise<UserFactorYubikeyOtpToken>;
  /**
  ...
  /**
      ...
      * @param userId ID of an existing Okta user
      */
  listSupportedFactors(userId: string, _options?: Configuration): Promise<Collection<UserFactorSupported>>;
  /**
      * Lists all available security questions for the specified user
      * List all supported security questions
      * @param userId ID of an existing Okta user
      */
  listSupportedSecurityQuestions(userId: string, _options?: Configuration): Promise<Collection<UserFactorSecurityQuestionProfile>>;
  /**
  ...
  /**
      ...
      */
  resendEnrollFactor(userId: string, factorId: string, resendUserFactor: ResendUserFactor, templateId?: string, _options?: Configuration): Promise<ResendUserFactor>;
  /**
      ...
      */
  unenrollFactor(userId: string, factorId: string, removeRecoveryEnrollment?: boolean, _options?: Configuration): Promise<void>;
  /**
...
export declare class PromiseUserTypeApi {
  ...
  /**
      ...
      * @param userType
      */
  replaceUserType(typeId: string, userType?: UserTypePutRequest, _options?: Configuration): Promise<UserType>;
  /**
      ...
      * @param userType
      */
  updateUserType(typeId: string, userType: UserTypePostRequest, _options?: Configuration): Promise<UserType>;
}
...
export declare class PromiseWebAuthnPreregistrationApi {
  private api;
  ...
  /**
      ...
      */
  activatePreregistrationEnrollment(body?: EnrollmentActivationRequest, _options?: Configuration): Promise<EnrollmentActivationResponse>;
  /**
      ...
      */
  assignFulfillmentErrorWebAuthnPreregistrationFactor(userId: string, authenticatorEnrollmentId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param authenticatorEnrollmentId ID for a WebAuthn preregistration factor in Okta
      */
  deleteWebAuthnPreregistrationFactor(userId: string, authenticatorEnrollmentId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  enrollPreregistrationEnrollment(body?: EnrollmentInitializationRequest, _options?: Configuration): Promise<EnrollmentInitializationResponse>;
  /**
      ...
      */
  generateFulfillmentRequest(body?: FulfillmentRequest, _options?: Configuration): Promise<void>;
  /**
      * Lists all WebAuthn preregistration factors for the specified user
      * List all WebAuthn preregistration factors
      * @param userId ID of an existing Okta user
      */
  listWebAuthnPreregistrationFactors(userId: string, _options?: Configuration): Promise<Collection<WebAuthnPreregistrationFactor>>;
  /**
...
export declare class PromiseYourOinIntegrationsApi {
  ...
  /**
      ...
      */
  createSubmission(submissionRequest?: SubmissionRequest, _options?: Configuration): Promise<SubmissionResponse>;
  /**
      ...
      */
  getSubmissionActions(submissionId: string, capability: 'sso' | 'universal_logout' | 'provisioning' | 'entitlements' | 'shared', _options?: Configuration): Promise<SubmissionActions>;
  /**
      * Retrieves the authentication settings for an OIN Integration submission
      * Retrieve the authentication settings
      * @param submissionId OIN Integration ID
      */
  getSubmissionAuthSettings(submissionId: string, _options?: Configuration): Promise<AuthSettings>;
  /**
      * Retrieves an OIN Integration by ID
      * Retrieve an OIN integration
      * @param submissionId OIN Integration ID
      */
  getSubmissionByOperationId(submissionId: string, _options?: Configuration): Promise<SubmissionResponse>;
  /**
      * Retrieves the tenant settings for an OIN Integration submission
      * Retrieve the tenant settings
      * @param submissionId OIN Integration ID
      */
  getSubmissionTenantSettings(submissionId: string, _options?: Configuration): Promise<TenantSettings>;
  /**
      * Retrieves the testing information for an existing OIN Integration
      * Retrieve an OIN integration testing information
      * @param submissionId OIN Integration ID
      */
  getSubmissionTestInfo(submissionId: string, _options?: Configuration): Promise<TestInfo>;
  /**
      ...
      */
  listAvailableActions(submissionId: string, capability: 'sso' | 'universal_logout' | 'provisioning' | 'entitlements' | 'shared', actionsProviderType: 'workflows', _options?: Configuration): Promise<AvailableActions>;
  /**
      * Lists all capabilities for an OIN Integration submission
      * List all supported capabilities
      * @param submissionId OIN Integration ID
      */
  listSubmissionCapabilities(submissionId: string, _options?: Configuration): Promise<SubmissionCapabilities>;
  /**
      ...
      */
  listSubmissions(limit?: number, after?: string, _options?: Configuration): Promise<Collection<SubmissionResponse>>;
  /**
      ...
      * @param submissionRequest
      */
  replaceSubmission(submissionId: string, submissionRequest?: SubmissionRequest, _options?: Configuration): Promise<SubmissionResponse>;
  /**
      * Submits an OIN Integration for Okta verification
      * Submit an OIN integration
      * @param submissionId OIN Integration ID
      */
  submitSubmission(submissionId: string, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param file
      */
  uploadSubmissionDefaultLogo(file?: HttpFile, _options?: Configuration): Promise<void>;
  /**
      ...
      * @param file
      */
  uploadSubmissionLogo(file?: HttpFile, _options?: Configuration): Promise<void>;
  /**
      ...
      */
  upsertSubmissionActions(submissionId: string, capability: 'sso' | 'universal_logout' | 'provisioning' | 'entitlements' | 'shared', submissionActions?: SubmissionActions, _options?: Configuration): Promise<SubmissionActions>;
  /**
      ...
      * @param authSettings
      */
  upsertSubmissionAuthSettings(submissionId: string, authSettings?: AuthSettings, _options?: Configuration): Promise<AuthSettings>;
  /**
      ...
      */
  upsertSubmissionCapabilities(submissionId: string, submissionCapabilities?: SubmissionCapabilities, _options?: Configuration): Promise<SubmissionCapabilities>;
  /**
      ...
      */
  upsertSubmissionTenantSettings(submissionId: string, tenantSettings?: TenantSettings, _options?: Configuration): Promise<TenantSettings>;
  /**
      ...
      * @param testInfo
      */
  upsertSubmissionTestInfo(submissionId: string, testInfo?: TestInfo, _options?: Configuration): Promise<TestInfo>;
  /**
      ...
      * @param actionsProviderType Actions provider type
      */
  verifyActions(submissionId: string, capability: 'sso' | 'universal_logout' | 'provisioning' | 'entitlements' | 'shared', actionsProviderType: 'workflows', _options?: Configuration): Promise<VerifyActions200Response>;
}
