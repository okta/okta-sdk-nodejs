...
export declare class PromiseApplicationApi {
  ...
  /**
      ...
      */
  activateOAuth2ClientJsonWebKey(appId: string, keyId: string, _options?: Configuration): Promise<OAuth2ClientJsonWebKey>;
  /**
  ...
  /**
      ...
      */
  addJwk(appId: string, oAuth2ClientJsonWebKeyRequestBody: OAuth2ClientJsonWebKeyRequestBody, _options?: Configuration): Promise<OAuth2ClientJsonWebKey>;
  /**
  ...
  /**
      ...
      */
  createCWOConnection(appId: string, orgCWOConnection: OrgCWOConnection, _options?: Configuration): Promise<OrgCWOConnection>;
  /**
  ...
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the OAuth 2.0 Client JSON Web Key
      */
  deactivateOAuth2ClientJsonWebKey(appId: string, keyId: string, _options?: Configuration): Promise<OAuth2ClientJsonWebKey>;
  /**
  ...
  /**
      ...
      */
  deleteCWOConnection(appId: string, connectionId: string, _options?: Configuration): Promise<void>;
  /**
  ...
  /**
      ...
      * @param appId Application ID
      */
  getAllCWOConnections(appId: string, _options?: Configuration): Promise<Collection<OrgCWOConnection>>;
  /**
  ...
  /**
      ...
      * @param connectionId Connection ID
      */
  getCWOConnection(appId: string, connectionId: string, _options?: Configuration): Promise<OrgCWOConnection>;
  /**
  ...
  /**
      ...
      * @param keyId Unique &#x60;id&#x60; of the OAuth 2.0 Client JSON Web Key
      */
  getJwk(appId: string, keyId: string, _options?: Configuration): Promise<OAuth2ClientJsonWebKey>;
  /**
  ...
  /**
      ...
      */
  listApplications(q?: string, after?: string, useOptimization?: boolean, limit?: number, filter?: string, expand?: string, includeNonDeleted?: boolean, _options?: Configuration): Promise<Collection<Application>>;
  /**
  ...
  /**
      ...
      */
  updateCWOConnection(appId: string, connectionId: string, orgCWOConnectionPatchRequest: OrgCWOConnectionPatchRequest, _options?: Configuration): Promise<OrgCWOConnection>;
  /**
...
export declare class PromiseAttackProtectionApi {
  ...
  /**
      ...
      */
  getAuthenticatorSettings(_options?: Configuration): Promise<Collection<AttackProtectionAuthenticatorSettings>>;
  /**
      * Retrieves the User Lockout Settings for an org
      * Retrieve the user lockout settings
      */
  getUserLockoutSettings(_options?: Configuration): Promise<Collection<UserLockoutSettings>>;
  /**
...
export declare class PromiseDirectoriesIntegrationApi {
  ...
  /**
      ...
      * @param agentAction
      */
  updateADGroupMembership(appInstanceId: string, agentAction: AgentAction, _options?: Configuration): Promise<void>;
}
...
export declare class PromiseGroupOwnerApi {
  private api;
...
export declare class PromiseGroupPushMappingApi {
  ...
  /**
      ...
      */
  listGroupPushMappings(appId: string, after?: string, limit?: number, search?: string, sortBy?: string, sortOrder?: string, _options?: Configuration): Promise<Collection<GroupPushMapping>>;
  /**
...
export declare class PromisePolicyApi {
  ...
  /**
      ...
      */
  listPolicies(type: 'OKTA_SIGN_ON' | 'PASSWORD' | 'MFA_ENROLL' | 'IDP_DISCOVERY' | 'ACCESS_POLICY' | 'PROFILE_ENROLLMENT' | 'POST_AUTH_SESSION' | 'ENTITY_RISK', status?: string, q?: string, expand?: string, sortBy?: string, limit?: string, resourceId?: string, after?: string, _options?: Configuration): Promise<Collection<Policy>>;
  /**
...
export declare class PromiseRealmAssignmentApi {
  ...
  /**
      ...
      * @param body
      */
  executeRealmAssignment(body: OperationRequest, _options?: Configuration): Promise<OperationResponse>;
  /**
  ...
  /**
      ...
      * @param after The cursor to use for pagination. It is an opaque string that specifies your current location in the list and is obtained from the &#x60;Link&#x60; response header. See [Pagination](https://developer.okta.com/docs/api/#pagination).
      */
  listRealmAssignmentOperations(limit?: number, after?: string, _options?: Configuration): Promise<Collection<OperationResponse>>;
  /**
...
export declare class PromiseResourceSetApi {
  ...
  /**
      ...
      * @param resourceSetId &#x60;id&#x60; or &#x60;label&#x60; of the resource set
      */
  listResourceSetResources(resourceSetId: string, _options?: Configuration): Promise<ResourceSetResources>;
  /**
...
export declare class PromiseRoleApi {
  private api;
...
export declare class PromiseRoleAssignmentApi {
  ...
  /**
      ...
      */
  assignRoleToClient(clientId: string, assignRoleRequest: AssignRoleToGroupRequest, _options?: Configuration): Promise<ListGroupAssignedRoles200ResponseInner>;
  /**
      ...
      */
  assignRoleToGroup(groupId: string, assignRoleRequest: AssignRoleToGroupRequest, disableNotifications?: boolean, _options?: Configuration): Promise<ListGroupAssignedRoles200ResponseInner | void>;
  /**
  ...
  /**
      ...
      */
  getGroupAssignedRole(groupId: string, roleId: string, _options?: Configuration): Promise<ListGroupAssignedRoles200ResponseInner>;
  /**
  ...
  /**
      ...
      * @param roleId The &#x60;id&#x60; of the role assignment
      */
  getUserAssignedRole(userId: string, roleId: string, _options?: Configuration): Promise<ListGroupAssignedRoles200ResponseInner>;
  /**
  ...
  /**
      ...
      * @param roleAssignmentId The &#x60;id&#x60; of the role assignment
      */
  retrieveClientRole(clientId: string, roleAssignmentId: string, _options?: Configuration): Promise<ListGroupAssignedRoles200ResponseInner>;
  /**
...
export declare class PromiseUserApi {
  ...
  /**
      ...
      */
  listUsers(contentType?: string, search?: string, filter?: string, q?: string, after?: string, limit?: number, sortBy?: string, sortOrder?: string, expand?: string, _options?: Configuration): Promise<Collection<User>>;
  /**
  ...
  /**
      ...
      */
  revokeUserSessions(userId: string, oauthTokens?: boolean, _options?: Configuration): Promise<void>;
  /**
