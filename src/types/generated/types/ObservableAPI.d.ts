...
export declare class ObservableUserFactorApi {
  ...
  /**
      ...
      */
  verifyFactor(userId: string, factorId: string, templateId?: string, tokenLifetimeSeconds?: number, xForwardedFor?: string, userAgent?: string, acceptLanguage?: string, body?: UserFactorVerifyRequest, _options?: Configuration): Observable<UserFactorVerifyResponse>;
}
