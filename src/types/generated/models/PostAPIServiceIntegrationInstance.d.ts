 ...
 */
import { APIServiceIntegrationLinks } from './../models/APIServiceIntegrationLinks';
import { AppProperties } from './../models/AppProperties';
export declare class PostAPIServiceIntegrationInstance {
  /**
  ...
  /**
    ...
    */
  'type'?: string;
  '_links'?: APIServiceIntegrationLinks;
  /**
