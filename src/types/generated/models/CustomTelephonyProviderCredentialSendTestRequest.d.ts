 ...
 */
export declare class CustomTelephonyProviderCredentialSendTestRequest {
  /**
  ...
  /**
    ...
    */
  'factor'?: CustomTelephonyProviderCredentialSendTestRequestFactorEnum;
  /**
...
export type CustomTelephonyProviderCredentialSendTestRequestFactorEnum = 'SMS' | 'CALL';
