...
* An EC signing key
*/
export declare class OAuth2ClientJsonWebKeyECResponse {
  /**
    * Cryptographic algorithm family for the certificate\'s key pair
    */
  'kty'?: OAuth2ClientJsonWebKeyECResponseKtyEnum;
  /**
  ...
  /**
    ...
    */
  'status'?: OAuth2ClientJsonWebKeyECResponseStatusEnum;
  /**
...
export type OAuth2ClientJsonWebKeyECResponseKtyEnum = 'EC';
export type OAuth2ClientJsonWebKeyECResponseStatusEnum = 'ACTIVE' | 'INACTIVE';
