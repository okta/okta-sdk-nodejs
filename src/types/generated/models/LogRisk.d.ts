...
export declare class LogRisk {
  ...
  /**
    ...
    */
  'level'?: LogRiskLevelEnum | null;
  /**
    * The previous risk level (if any) associated with the user
    */
  'previousLevel'?: LogRiskPreviousLevelEnum | null;
  /**
...
export type LogRiskLevelEnum = 'LOW' | 'MEDIUM' | 'HIGH';
export type LogRiskPreviousLevelEnum = 'LOW' | 'MEDIUM' | 'HIGH';
