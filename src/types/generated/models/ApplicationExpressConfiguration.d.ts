 ...
 */
import { ApplicationCapability } from './../models/ApplicationCapability';
/**
...
*/
export declare class ApplicationExpressConfiguration {
  /**
    * Capabilities currently enabled for the app
    */
  'enabledCapabilities'?: Array<ApplicationCapability>;
  /**
    * Capabilities supported by the app
    */
  'supportedCapabilities'?: Array<ApplicationCapability>;
