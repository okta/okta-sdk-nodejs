...
* An EC signing key
*/
export declare class AgentJsonWebKeyECResponse {
  /**
    * The cryptographic curve that\'s used for the key pair
    */
  'crv'?: AgentJsonWebKeyECResponseCrvEnum;
  /**
    * Cryptographic algorithm family for the certificate\'s key pair
    */
  'kty': AgentJsonWebKeyECResponseKtyEnum;
  /**
  ...
  /**
    ...
    */
  'status'?: AgentJsonWebKeyECResponseStatusEnum;
  /**
  ...
  /**
    ...
    */
  'use'?: AgentJsonWebKeyECResponseUseEnum;
  /**
...
export type AgentJsonWebKeyECResponseCrvEnum = 'P-256' | 'P-384' | 'P-521';
export type AgentJsonWebKeyECResponseKtyEnum = 'EC';
export type AgentJsonWebKeyECResponseStatusEnum = 'ACTIVE' | 'INACTIVE';
export type AgentJsonWebKeyECResponseUseEnum = 'sig';
