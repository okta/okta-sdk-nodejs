 ...
 */
import { EntityRiskPolicyRuleActionsObject } from './../models/EntityRiskPolicyRuleActionsObject';
/**
* The object that contains the `actions` array
*/
export declare class EntityRiskPolicyRuleActionsEntityRisk {
  /**
    ...
    */
  'actions'?: Array<EntityRiskPolicyRuleActionsObject>;
