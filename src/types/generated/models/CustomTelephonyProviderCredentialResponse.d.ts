...
export declare class CustomTelephonyProviderCredentialResponse {
  /**
  ...
  /**
    ...
    */
  'providerCapability'?: CustomTelephonyProviderCredentialResponseProviderCapabilityEnum;
  /**
    * Name of the telephony provider
    */
  'providerName'?: CustomTelephonyProviderCredentialResponseProviderNameEnum;
...
export type CustomTelephonyProviderCredentialResponseProviderCapabilityEnum = 'ALL';
export type CustomTelephonyProviderCredentialResponseProviderNameEnum = 'TWILIO' | 'TELESIGN';
