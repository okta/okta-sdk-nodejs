...
*/
export declare class OAuth2ClientJsonEncryptionKeyRequest {
  /**
  ...
  /**
    ...
    */
  'kty'?: OAuth2ClientJsonEncryptionKeyRequestKtyEnum;
  /**
  ...
  /**
    ...
    */
  'use'?: OAuth2ClientJsonEncryptionKeyRequestUseEnum;
  /**
  ...
  /**
    ...
    */
  'status'?: OAuth2ClientJsonEncryptionKeyRequestStatusEnum;
...
export type OAuth2ClientJsonEncryptionKeyRequestKtyEnum = 'RSA';
export type OAuth2ClientJsonEncryptionKeyRequestUseEnum = 'enc';
export type OAuth2ClientJsonEncryptionKeyRequestStatusEnum = 'ACTIVE' | 'INACTIVE';
