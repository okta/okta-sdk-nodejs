...
*/
export declare class SalesforceApplicationSettingsApplication {
  /**
    * Salesforce instance that you want to connect to
    */
  'instanceType': SalesforceApplicationSettingsApplicationInstanceTypeEnum;
  /**
    * Salesforce integration type
    */
  'integrationType': SalesforceApplicationSettingsApplicationIntegrationTypeEnum;
  /**
