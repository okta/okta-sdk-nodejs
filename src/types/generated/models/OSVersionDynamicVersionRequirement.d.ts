...
*/
export declare class OSVersionDynamicVersionRequirement {
  /**
...
export declare type OSVersionDynamicVersionRequirementTypeEnum = 'MINIMUM' | 'EXACT' | 'EXACT_ANY_SUPPORTED';
