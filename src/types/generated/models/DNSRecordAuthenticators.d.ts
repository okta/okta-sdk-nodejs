 ...
 */
import { DNSRecordTypeAuthenticators } from './../models/DNSRecordTypeAuthenticators';
/**
...
*/
export declare class DNSRecordAuthenticators {
  /**
    * The DNS record name
    */
  'fqdn'?: string;
  'recordType'?: DNSRecordTypeAuthenticators;
  /**
