...
* An RSA signing key
*/
export declare class OAuth2ClientJsonWebKeyRsaResponse {
  /**
  ...
  /**
    ...
    */
  'kty'?: OAuth2ClientJsonWebKeyRsaResponseKtyEnum;
  /**
  ...
  /**
    ...
    */
  'status'?: OAuth2ClientJsonWebKeyRsaResponseStatusEnum;
  /**
...
export type OAuth2ClientJsonWebKeyRsaResponseKtyEnum = 'RSA';
export type OAuth2ClientJsonWebKeyRsaResponseStatusEnum = 'ACTIVE' | 'INACTIVE';
