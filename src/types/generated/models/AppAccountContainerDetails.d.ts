 ...
 */
import { AppAccountContainerLink } from './../models/AppAccountContainerLink';
import { AppInstanceContainerStatus } from './../models/AppInstanceContainerStatus';
/**
* Container details for resource type APP_ACCOUNT
*/
export declare class AppAccountContainerDetails {
  /**
  ...
  /**
    ...
    */
  'passwordPushSupported'?: boolean;
  /**
    * Indicates if provisioning is enabled for this application
    */
  'provisioningEnabled'?: boolean;
  'status'?: AppInstanceContainerStatus;
  '_links'?: AppAccountContainerLink;
