 ...
 */
import { OfflineAccessScopeResourceHrefObject } from './../models/OfflineAccessScopeResourceHrefObject';
/**
...
*/
export declare class OAuth2RefreshTokenScopeLinks {
  /**
    * Link to Scope resource
    */
  'scope'?: OfflineAccessScopeResourceHrefObject;
