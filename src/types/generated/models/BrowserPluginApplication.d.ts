...
import { SwaApplicationSettings } from './../models/SwaApplicationSettings';
export declare class BrowserPluginApplication extends Application {
  'credentials'?: SchemeApplicationCredentials;
  /**
    * The key name for the app definition
    */
  'name': BrowserPluginApplicationNameEnum;
