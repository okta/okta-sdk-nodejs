 ...
 */
import { UserFactorActivatePushResult } from './../models/UserFactorActivatePushResult';
/**
...
*/
export declare class UserFactorActivatePush {
  /**
    * Timestamp when the factor verification attempt expires
    */
  'expiresAt'?: Date;
  'factorResult'?: UserFactorActivatePushResult;
