 ...
 */
import { AuthenticatorMethodConstraint } from './../models/AuthenticatorMethodConstraint';
/**
* Defines the authenticators permitted for the initial authentication step of password recovery
*/
export declare class SsprPrimaryRequirement {
  /**
    ...
    */
  'methodConstraints'?: Array<AuthenticatorMethodConstraint>;
  /**
    ...
    */
  'methods'?: Array<SsprPrimaryRequirementMethodsEnum>;
