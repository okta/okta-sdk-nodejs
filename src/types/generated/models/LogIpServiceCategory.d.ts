...
*/
export declare class LogIpServiceCategory {
  /**
  ...
  /**
    ...
    */
  'type'?: LogIpServiceCategoryTypeEnum | null;
...
export type LogIpServiceCategoryTypeEnum = 'VPN' | 'Proxy' | 'Tor' | 'Residential Proxy' | 'Blockchain VPN';
