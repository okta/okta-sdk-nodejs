...
import { WebAuthnCredResponse } from './../models/WebAuthnCredResponse';
/**
* Enrollment Initialization Request
*/
export declare class EnrollmentActivationRequest {
  /**
    * List of credential responses from the fulfillment provider
    */
  'credResponses'?: Array<WebAuthnCredResponse>;
  /**
    * Name of the fulfillment provider for the WebAuthn preregistration factor
    */
  'fulfillmentProvider'?: EnrollmentActivationRequestFulfillmentProviderEnum;
  /**
  ...
  /**
    ...
    */
  'yubicoSigningJwks'?: Array<ECKeyJWK>;
