 ...
 */
import { DevicePostureChecks } from './../models/DevicePostureChecks';
import { GracePeriod } from './../models/GracePeriod';
import { LinksSelf } from './../models/LinksSelf';
import { Platform } from './../models/Platform';
export declare class DeviceAssurance {
  'createdBy'?: string;
  'createdDate'?: string;
  'devicePostureChecks'?: DevicePostureChecks;
  /**
    * Represents the remediation mode of this device assurance policy when users are denied access due to device noncompliance
    */
  'displayRemediationMode'?: DeviceAssuranceDisplayRemediationModeEnum;
