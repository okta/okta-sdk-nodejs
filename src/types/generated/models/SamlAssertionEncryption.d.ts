...
*/
export declare class SamlAssertionEncryption {
  /**
  ...
  /**
    ...
    */
  'encryptionAlgorithm'?: SamlAssertionEncryptionEncryptionAlgorithmEnum;
  /**
    * The key transport algorithm used to encrypt the SAML assertion
    */
  'keyTransportAlgorithm'?: SamlAssertionEncryptionKeyTransportAlgorithmEnum;
  /**
