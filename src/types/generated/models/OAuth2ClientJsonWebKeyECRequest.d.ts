...
* An EC signing key
*/
export declare class OAuth2ClientJsonWebKeyECRequest {
  /**
    * Cryptographic algorithm family for the certificate\'s key pair
    */
  'kty'?: OAuth2ClientJsonWebKeyECRequestKtyEnum;
  /**
  ...
  /**
    ...
    */
  'status'?: OAuth2ClientJsonWebKeyECRequestStatusEnum;
...
export type OAuth2ClientJsonWebKeyECRequestKtyEnum = 'EC';
export type OAuth2ClientJsonWebKeyECRequestStatusEnum = 'ACTIVE' | 'INACTIVE';
