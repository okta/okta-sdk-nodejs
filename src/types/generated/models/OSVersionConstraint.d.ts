 ...
 */
import { OSVersionConstraintDynamicVersionRequirement } from './../models/OSVersionConstraintDynamicVersionRequirement';
export declare class OSVersionConstraint {
  'dynamicVersionRequirement'?: OSVersionConstraintDynamicVersionRequirement;
  /**
    * Indicates the Windows major version
    */
  'majorVersionConstraint': OSVersionConstraintMajorVersionConstraintEnum;
  /**
