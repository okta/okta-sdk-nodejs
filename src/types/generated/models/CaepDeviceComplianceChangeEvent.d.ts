...
*/
export declare class CaepDeviceComplianceChangeEvent {
  /**
    * Current device compliance status
    */
  'current_status': CaepDeviceComplianceChangeEventCurrentStatusEnum;
  /**
  ...
  /**
    ...
    */
  'initiating_entity'?: CaepDeviceComplianceChangeEventInitiatingEntityEnum;
  /**
    * Previous device compliance status
    */
  'previous_status': CaepDeviceComplianceChangeEventPreviousStatusEnum;
