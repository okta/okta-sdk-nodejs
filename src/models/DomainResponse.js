...
class DomainResponse extends Resource {
  constructor(resourceJson, client) {
    ...
    if (resourceJson && resourceJson._links) {
      this._links = new DomainLinks(resourceJson._links);
    }
