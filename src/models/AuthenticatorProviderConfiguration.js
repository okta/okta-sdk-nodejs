...
class AuthenticatorProviderConfiguration extends Resource {
  constructor(resourceJson, client) {
    ...
    if (resourceJson && resourceJson.userNameTemplate) {
      this.userNameTemplate = new AuthenticatorProviderConfigurationUserNamePlate(resourceJson.userNameTemplate);
    }
  }

}

module.exports = AuthenticatorProviderConfiguration;
