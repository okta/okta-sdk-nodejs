...
import { Application, ApiClient, DefaultRequestExecutor, User, AppUser } from '@okta/okta-sdk-nodejs';
...
xdescribe('AppUser.delete()', () => {
  ...
  it('should allow me to delete the app user', async () => {
    ...
    try {
      ...
      const response = await client.userApi.deleteUser({id: createdAppUser.id});
