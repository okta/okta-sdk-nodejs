...
get_vault_secret_key devex/okta-sdk-nodejs-oie_apiKey api_key OKTA_CLIENT_TOKEN
export OKTA_CLIENT_CLIENTID=0oa1niakaghOQ2XEv1d7
...
if ! yarn test:integration:ssws; then
